...
| `GUIDE-03` | Parallel problem-list surface outside the canonical browser | Check whether a guide, wiki page, or collection page is materializing a metadata-selected problem list or implementing its own sampling/filtering. Authored filters/source identity should deep-link to `problems.html`; source order and locators remain collection data and are reproduced there. | [#66](https://github.com/dzackgarza/new-qual-site/issues/66), [#63](https://github.com/dzackgarza/new-qual-site/issues/63) |
