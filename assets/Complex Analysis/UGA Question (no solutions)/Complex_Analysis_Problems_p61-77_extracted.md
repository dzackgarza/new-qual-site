## 20.4.4 Tie’s Extra Questions: Spring 2014
...
## 20.4.5 Tie’s Extra Questions: Spring 2014
...
## 20.4.6 Tie’s Extra Questions: Spring 2014
...
## 20.4.7 Tie’s Extra Questions: Spring 2014
...
## 20.4.10 Tie’s Extra Questions: Spring 2014
...
(a) Let z, w be complex numbers, such that zw $\neq 1$ . Prove that
...
## 20.5.3 Tie’s Extra Questions: Fall 2015### Tie’s Extra Questions: Fall 2015
...
$$
H i n t \colon 1 - \cos 2 \theta = 2 \sin ^ { 2 } \theta , \sin 2 \theta = 2 \sin \theta \cos \theta .
$$
...
## 20.5.4 Tie’s Extra Questions: Fall 2015### Tie’s Extra Questions: Fall 2015

Assume f is continuous in the region: $x \geq x _ { 0 } , 0 \leq y \leq b$ and the limit
...
## 20.5.5 Tie’s Extra Questions: Fall 2015### Tie’s Extra Questions: Fall 2015

(Cauchy’s formula for “exterior” region) Let γ be piecewise smooth simple closed curve with interior $\Omega _ { 1 }$ and exterior $\Omega _ { 2 }$ . Assume $f ^ { \prime } ( z )$ exists in an open set containing $\gamma$ and $\Omega _ { 2 }$ and $\operatorname* { l i m } _ { z \to \infty } f ( z ) = A$ Show that
...
## 20.5.7 Tie’s Extra Questions: Fall 2015### Tie’s Extra Questions: Fall 2015

Prove by justifying all steps that for all $\xi \in \mathbb { C }$ we have $e ^ { - \pi \xi ^ { 2 } } = \int _ { - \infty } ^ { \infty } e ^ { - \pi x ^ { 2 } } e ^ { 2 \pi i x \xi } d x$

Hint: You may use that fact in Example 1 on $p . \ 4 2$ of the textbook without proof, i.e., you may assume the above is true for real values of ξ.
...
Let f be entire and suppose that $\operatorname* { l i m } _ { z \to \infty } f ( z ) = \infty$ . Show that f is a polynomial.

## 20.5.11 Tie’s Extra Questions: Fall 2015### Tie’s Extra Questions: Fall 2015

Expand the following functions into Laurent series in the indicated regions:

$$
f ( z ) = \frac { z ^ { 2 } - 1 } { ( z + 2 ) ( z + 3 ) } , 2 < | z | < 3 , 3 < | z | < + \infty .
$$
...
## 20.5.12 Tie’s Extra Questions: Fall 2015### Tie’s Extra Questions: Fall 2015

Assume $f ( z )$ is analytic in region D and Γ is a rectifiable curve in D with interior in D. Prove that if $f ( z )$ is real for all $z \in \Gamma$ , then $f ( z )$ is a constant.

## 20.5.13 Tie’s Extra Questions: Fall 2015### Tie’s Extra Questions: Fall 2015

Find the number of roots of $z ^ { 4 } - 6 z + 3 = 0 \ \mathrm { i n } \ | z | < 1$ and $1 < | z | < 2$ respectively.

## 20.5.14 Tie’s Extra Questions: Fall 2015### Tie’s Extra Questions: Fall 2015

Prove that $z ^ { 4 } + 2 z ^ { 3 } - 2 z + 1 0 = 0$ has exactly one root in each open quadrant.

## 20.5.15 Tie’s Extra Questions: Fall 2015### Tie’s Extra Questions: Fall 2015

(1) Let $f ( z ) \in H ( \mathbb { D } ) , \operatorname { R e } ( f ( z ) ) > 0 , f ( 0 ) = a > 0$ . Show that

$$
| \frac { f ( z ) - a } { f ( z ) + a } | \leq | z | , | f ^ { \prime } ( 0 ) | \leq 2 a .
$$

(2) Show that the above is still true if $\operatorname { R e } ( f ( z ) ) > 0$ is replaced with $\mathrm { R e } ( f ( z ) ) \geq 0$
...
Let $f ( z ) = \sum _ { n = 0 } ^ { \infty } c _ { n } z ^ { n }$ be analytic and one-to-one in $| z | < 1$ . For $0 < r < 1$ , let $D _ { r }$ be the disk $| z | < r$ Show that the area of $f ( D _ { r } )$ is finite and is given by
...
## 20.5.18 Tie’s Extra Questions: Fall 2015### Tie’s Extra Questions: Fall 2015

Let $f ( z ) = \sum _ { { \cal \ L } } ^ { \infty } c _ { n } z ^ { n }$ be analytic and one-to-one in $r _ { 0 } < | z | < R _ { 0 }$ . For $r _ { 0 } < r < R < R _ { 0 }$ , let n=−∞ $D ( r , R )$ be the annulus $r < | z | < R$ . Show that the area of $f ( D ( r , R ) )$ is finite and is given by
...
## 20.6.1 Tie’s Extra Questions: Spring 2015

Let $f _ { n } , f$ be analytic functions on the unit disk D. Show that the following are equivalent.

(i) $f _ { n } ( z )$ converges to f(z) uniformly on compact subsets in D.

(ii) $\int _ { | z | = r } | f _ { n } ( z ) - f ( z ) | | d z |$ converges to 0 if $0 < r < 1$

## 20.6.2 Tie’s Extra Questions: Spring 2015

Let f and g be non-zero analytic functions on a region Ω. Assume $| f ( z ) | = | g ( z ) |$ for all z in Ω. Show that $f ( z ) = e ^ { i \theta } g ( z )$ in Ω for some $0 \leq \theta < 2 \pi$

## 20.6.3 Tie’s Extra Questions: Spring 2015
...
Let $f ( z ) = { \frac { 1 } { z } } + { \frac { 1 } { z ^ { 2 } - 1 } }$ . Find all the Laurent series of f and describe the largest annuli in which these series are valid.
...
## 20.6.8 Tie’s Extra Questions: Spring 2015
...
## 20.6.10 Tie’s Extra Questions: Spring 2015

Let f be holomorphic in a neighborhood of $D _ { r } ( z _ { 0 } )$ . Show that for any $s < r$ , there exists a constant $c > 0$ such that

$$
\| f \| _ { ( \infty , s ) } \leq c \| f \| _ { ( 1 , r ) } ,
$$

where $| f | | _ { ( \infty , s ) } = \operatorname* { s u p } _ { z \in D _ { s } ( z _ { 0 } ) } | f ( z ) |$ and $| | f | | _ { ( 1 , r ) } = \int _ { D _ { r } ( z _ { 0 } ) } | f ( z ) | d x d y .$
...
## 20.6.11 Tie’s Extra Questions: Spring 2015

(1) Let f be analytic in $\Omega : 0 < | z - a | < r$ except at a sequence of poles $a _ { n } \in \Omega$ with lim $a _ { n } = a$ n→∞ Show that for any $w \in \mathbb { C } .$ , there exists a sequence $z _ { n } \in \Omega$ such that $\operatorname* { l i m } _ { n \to \infty } f ( z _ { n } ) = { \overset { . . . } { w } }$

(2) Explain the similarity and difference between the above assertion and the Weierstrass-Casorati theorem.

## 20.6.12 Tie’s Extra Questions: Spring 2015

Compute the following integrals.

$$
\begin{array} { l } { i \displaystyle \int _ { 0 } ^ { \infty } \displaystyle \frac { 1 } { ( 1 + x ^ { n } ) ^ { 2 } } d x , n \geq 1 \ \mathrm { ( i i ) } \ \int _ { 0 } ^ { \infty } \displaystyle \frac { \cos x } { ( x ^ { 2 } + a ^ { 2 } ) ^ { 2 } } d x , a \in \mathbb { R } \ \mathrm { ( i i i ) } \ \int _ { 0 } ^ { \pi } \displaystyle \frac { 1 } { a + \sin \theta } d \theta , a > 1 } \\ { i v \displaystyle \int _ { 0 } ^ { \frac { \pi } { 2 } } \displaystyle \frac { d \theta } { a + \sin ^ { 2 } \theta } , a > 0 . \ \mathrm { ( v ) } \displaystyle \int _ { | z | = 2 } \displaystyle \frac { 1 } { ( z ^ { 5 } - 1 ) ( z - 3 ) } d z \ \mathrm { ( v ) } \displaystyle \int _ { - \infty } ^ { \infty } \displaystyle \frac { \sin \pi a } { \cosh \pi x + \cos \pi a } e ^ { - i x \xi } d x , \ 0 < a < 1 , } \\ { \xi \in \mathbb { R } \ \mathrm { ( v i ) } \displaystyle \int _ { | z | = 1 } \cot ^ { 2 } z d z . } \end{array}
$$

## 20.6.13 Tie’s Extra Questions: Spring 2015

Compute the following integrals.

$$
 \begin{array} { l } { { \displaystyle { \dot { \ i } } \int _ { 0 } ^ { \infty } { \frac { \sin x } { x } } d x \ { \mathrm { ( i i ) } } \int _ { 0 } ^ { \infty } { \bigl ( } { \frac { \sin x } { x } } { \bigr ) ^ { 2 } } d x \ { \mathrm { ( i i i ) } } \int _ { 0 } ^ { \infty } { \frac { x ^ { a - 1 } } { ( 1 + x ) ^ { 2 } } } d x , 0 < a < 2 } \\ { { \dot { \iota } } } \\ { { \dot { \iota } } \int _ { 0 } ^ { \infty } { \frac { \cos a x - \cos b x } { x ^ { 2 } } } d x , a , b > 0 \ { \mathrm { ( i i ) } } \int _ { 0 } ^ { \infty } { \frac { x ^ { a - 1 } } { 1 + x ^ { n } } } d x , 0 < a < n } \\ { { \dot { \iota } } { \dot { \iota } } i \int _ { 0 } ^ { \infty } { \frac { \log x } { 1 + x ^ { n } } } d x , n \geq 2 \ { \mathrm { ( i v ) } } \int _ { 0 } ^ { \infty } { \frac { \log x } { ( 1 + x ^ { 2 } ) ^ { 2 } } } d x \ { \mathrm { ( v ) } } \int _ { 0 } ^ { \pi } \log | 1 - a \sin \theta | d \theta , a \in \mathbb { C } } \end{array} }
$$

## 20.6.14 Tie’s Extra Questions: Spring 2015

Let $0 < r < 1$ . Show that polynomials $P _ { n } ( z ) = 1 + 2 z + 3 z ^ { 2 } + \cdot \cdot \cdot + n z ^ { n - 1 }$ have no zeros in $| z | < r$ for all sufficiently large $n \mathrm { { ^ { \circ } s } }$

## 20.6.15 Tie’s Extra Questions: Spring 2015

Let $f$ be an analytic function on a region Ω. Show that $f$ is a constant if there is a simple closed curve $\gamma$ in Ω such that its image $f ( \gamma )$ is contained in the real axis.

## 20.6.16 Tie’s Extra Questions: Spring 2015

(1) Show that $\frac { \pi ^ { 2 } } { \sin ^ { 2 } \pi z }$ and $g ( z ) = \sum _ { n = - \infty } ^ { \infty } \frac { 1 } { ( z - n ) ^ { 2 } }$ have the same principal part at each integer point.
...
Assume $f ( z )$ is analytic in $\mathbb { D } : | z | < 1$ and $f ( 0 ) = 0$ and is not a rotation $( \mathrm { i . e . } ~ f ( z ) \neq e ^ { i \theta } z )$ Show that $\sum _ { n = 1 } ^ { \infty } f ^ { n } ( z )$ converges uniformly to an analytic function on compact subsets of D, where $f ^ { n + 1 } ( z ) = f ( f ^ { n } ( z ) )$

## 20.6.19 Tie’s Extra Questions: Spring 2015

Let f be a non-constant analytic function on D with $f ( \mathbb { D } ) \subseteq \mathbb { D }$ . Use $\psi _ { a } ( f ( z ) )$ (where $a = f ( 0 )$ $\psi _ { a } ( z ) = \frac { a - z } { 1 - \bar { a } z } )$ to prove that $\frac { | f ( 0 ) | - | z | } { 1 + | f ( 0 ) | | z | } \leq | f ( z ) | \leq \frac { | f ( 0 ) | + | z | } { 1 - | f ( 0 ) | | z | } ,$

## 20.6.20 Tie’s Extra Questions: Spring 2015

Find a conformal map

1. from $\{ z : | z - 1 / 2 | > 1 / 2 , { \mathrm { R e } } ( z ) > 0 \}$ to H

2. from $\{ z : | z - 1 / 2 | > 1 / 2 , | z | < 1 \}$ to D
...
5. from $\{ z : | z | < 1 , \mathrm { R e } ( z ) > 0 \} \backslash ( 0 , 1 / 2 ] \mathrm { ~ t o ~ } \mathbb { H }$

## 20.6.21 Tie’s Extra Questions: Spring 2015

Let C and $C ^ { \prime }$ be two circles and let $z _ { 1 } \in C , z _ { 2 } \notin C , z _ { 1 } ^ { \prime } \in C ^ { \prime } , z _ { 2 } ^ { \prime } \notin C ^ { \prime }$ . Show that there is a unique fractional linear transformation $f$ with $f ( C ) = C ^ { \prime }$ and $f ( z _ { 1 } ) = z _ { 1 } ^ { \prime } , f ( z _ { 2 } ) = z _ { 2 } ^ { \prime }$

## 20.6.22 Tie’s Extra Questions: Spring 2015
...
## 20.6.23 Tie’s Extra Questions: Spring 2015
...
## 20.6.24 Tie’s Extra Questions: Spring 2015

Prove that $f ( z ) = - \frac { 1 } { 2 } \left( z + \frac { 1 } { z } \right)$ is a conformal map from half disc $\left\{ z = x + i y : ~ | z | < 1 , ~ y > 0 \right\}$ to upper half plane $\mathbb { H } = \left\{ \dot { z } = x + i y : ~ y > 0 \right\}$
...
Prove that $f ( z ) = - \frac { 1 } { 2 } \left( z + \frac { 1 } { z } \right)$ is a conformal map from half disc $\left\{ z = x + i y : ~ | z | < 1 , ~ y > 0 \right\}$ to upper half plane H $= \{ \dot { z } = x + i y : ~ y > 0 \}$
...
## 20.6.33 Tie’s Extra Questions: Spring 2015
...
## 20.7.1 Tie’s Extra Questions: Fall 2016
...
(c) Describe the level curves of $\operatorname { R e } ( f )$ and of Im(f ).
...
(b) Assume that there exists a constant M such that $| f ( \tau ) | \le M$ for all $\tau \in$ Image(α). Prove that
...
## 20.7.5 Tie’s Extra Questions: Fall 2016
...
## 20.7.6 Tie’s Extra Questions: Fall 2016
...
## 20.7.7 Tie’s Extra Questions: Fall 2016

Find the conformal map that takes the upper half-plane comformally onto the half-strip $\{ w =$ $x + i y : \ - \pi / 2 < x < \pi / 2 \ y > 0 \}$

## 20.7.8 Tie’s Extra Questions: Fall 2016

Compute the integral $\int _ { - \infty } ^ { \infty } { \frac { e ^ { - 2 \pi i x \xi } } { \cosh \pi x } }$ dx where cosh $z = { \frac { e ^ { z } + e ^ { - z } } { 2 } }$
...
$$
f ( z ) : = \int _ { \gamma } \frac { F ( w ) } { w - z } d w
$$
...
$$
I = \int _ { 0 } ^ { \infty } { \frac { 1 } { 1 + x ^ { n } } } d x
$$
...
Hint: $e ^ { \pi \log w _ { n } } = w _ { n } ^ { n }$ and $e ^ { x }$ is uniform continuous on compact subsets $o f \mathbb { C }$

## 21.5 Fall 2021 #5

Assume f is an entire function such that $| f ( z ) | = 1 \ \mathrm { o n } \ | z | = 1$ . Prove that $f ( z ) = e ^ { i \theta } z ^ { n }$ , where $\theta$ is a real number and n a non-negative integer.

Suggestion: First use the maximum and minimum modulus theorem to show

$$
f ( z ) = e ^ { i \theta } \prod _ { k = 1 } ^ { n } { \frac { z - z _ { k } } { 1 - { \overline { { z _ { k } } } } z } }
$$
