...
1. Show that every compact metrizable space has a countable basis.

2. For a topological space X and $y \in X$ , the path component $P _ { y }$ of X containing y is the largest path-connected subset with $y \in P _ { y } \subseteq X$
...
(a) If $( X , T ^ { \prime } )$ is normal, must $( X , \tau )$ also be normal?

(b) If $( X , T ^ { \prime } )$ is compact, must $( X , \tau )$ also be compact?

(Prove your answers in both parts.)

## Section B:

5. Let $D ^ { 2 }$ be the closed unit disk in $\mathbb { R } ^ { 2 }$ and let ∼ be the smallest equivalence relation on $D ^ { 2 }$ satisfying $( \cos ( \theta ) , \sin ( \theta ) ) \sim ( \cos ( \theta + \frac { 2 \pi } { 3 } ) , \sin ( \theta + \frac { 2 \pi } { 3 } ) )$ and $( \cos ( \theta ) , \sin ( \theta ) ) \sim$ $( \cos ( - \theta ) , \sin ( - \theta ) )$ ) for all $\theta \in [ 0 , \frac { 2 \pi } { 3 } ]$ . Let $X : = \mathbf { \bar {  { D } } } ^ { 2 } / \mathbf { \varepsilon } \sim$ be the corresponding quotient space.
...
8. Let X be the space obtained by attaching a torus $T = S ^ { 1 } \times S ^ { 1 }$ to a cylinder $C = S ^ { 1 } \times I$ via a homemorphism of the circle $S ^ { 1 } \times \{ ( 1 , 0 ) \}$ of T with the circle $S ^ { 1 } \times \{ 0 \}$ of C. Compute the homology groups of X.