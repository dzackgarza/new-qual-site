...
Let R be a commutative ring and consider $R [ x ]$ . Define $\phi : R \to R [ x ]$ by $r \mapsto r$ . Clearly φ is one-to-one and a homomorphism. Now, $\phi ( R )$ is a subring of $R [ x ]$ since it is the image of a homomorphism. Then $\phi ( R )$ is a subring of $R [ x ]$ isomorphic to R.
...
No, there are not any. Consider $f ( x ) g ( x ) = ( a _ { n } x ^ { n } + \cdot \cdot \cdot + a _ { 1 } x + a _ { 0 } ) ( b _ { m } x ^ { m } + \cdot \cdot \cdot + b _ { 1 } x + b _ { 0 } ) =$ $a _ { n } b _ { m } x ^ { n + m } + \cdot \cdot \cdot + a _ { 0 } b _ { 0 }$ and $a _ { n } b _ { m } \neq 0$ . For this to have a multiplicative inverse, each nonconstant term in $f ( x ) g ( x )$ must be 0, but $a _ { n } b _ { m } \neq 0$ shows this is not so.
...
First, let’s look at $\mathbb { Q } [ x ] / < x >$ . This quotient ring contains cosets that look like $a + < x >$ where $a \in \mathbb { Q }$ . Thus, using the map $\mathbb { Q } [ x ] / < x > \to \mathbb { Q }$ defined by $a + < x > \mapsto a$ is an isomorphism. Thus $\mathbb { Q } [ x ] / < x > \approx \mathbb { Q }$ . Now, Q is a field so $< x >$ is maximal.
...
Let R be a ring and x be an indeterminate. Consider the rings $R [ x ]$ and $R [ x ^ { 2 } ]$ . To show that they are isomorphic, let $\phi : R [ x ] \to R [ x ^ { 2 } ]$ be defined by $f ( x ) \mapsto f ( x ^ { 2 } )$ . We see that addition is preserved since $\phi ( f ( x ) + g ( x ) ) = \phi ( ( f + g ) ( x ) ) = ( f + g ) ( x ^ { 2 } ) = f ( x ^ { 2 } ) + g ( x ^ { 2 } ) = \phi ( f ( x ) ) + \phi ( g ( x ) )$ . Similarly, it is clear that multiplication is preserved. This is one-to-one since $\operatorname { k e r } \phi = \{ f ( x ) | f ( x ^ { 2 } ) = 0 \} = \{ 0 \}$ , and onto is also straightforward to show.
