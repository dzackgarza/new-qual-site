...
The problems are listed in no particular order.

Problem 1. Set $a _ { 1 } = 0$ and define a sequence $\left\{ a _ { n } \right\}$ via the recurrence

$$
a _ { n + 1 } = { \sqrt { 6 + a _ { n } } } \qquad { \mathrm { f o r ~ a l l ~ } } n \geq 1 .
$$

Show that this sequence converges and determine the limiting value.

Problem 2. Compute the norm of the matrix
...
$$
P ( 0 ) = \alpha , \quad P ^ { \prime } ( 0 ) = \beta , \quad P ( 1 ) = \gamma , \quad \mathrm { a n d } \quad P ^ { \prime } ( 1 ) = \delta
$$
...
$$
\int _ { 0 } ^ { 1 } { \frac { d x } { 1 + x ^ { 2 } } } = \operatorname* { l i m } _ { N \to \infty } \sum _ { n = 0 } ^ { N } { \frac { ( - 1 ) ^ { n } } { 2 n + 1 } }
$$

(b) Deduce the value of $1 - { \textstyle { \frac { 1 } { 3 } } } + { \textstyle { \frac { 1 } { 5 } } } - { \textstyle { \frac { 1 } { 7 } } } + \cdots$

Problem 11. (a) Explain the following (overly informal) statement:
...
for all balls Ω (with all radii $r > 0$ and all possible centers).

[You may use the various standard theorems of vector calculus without proof.]
