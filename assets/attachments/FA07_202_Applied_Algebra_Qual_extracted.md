Algebra/ Applied Alg Qual Part 1: Matrix Theory September 12, 2007 Name Staple to your work on Part 1.
...
(16) 3 (a) Use Schur's Theorem to prove that every square matrix is arbitrarily close to a diagonalizable matrix.

(b) Show that a square matrix matrix A has an orthonormal basis of eigenvectors iff $A ^ { H } A = . 4 A ^ { H } ( A ^ { \ast } A = . 4 . 4 ^ { \ast } )$
