...
A nonzero module is [[D-4KM4P|simple]] if its only submodules are $0$ and itself, [[D-4HEUB|indecomposable]] if it is not a direct sum of two nonzero submodules, and [[D-HY7UU|cyclic]] if it is generated by one element; a module is Noetherian if every ascending chain of submodules stabilizes.
