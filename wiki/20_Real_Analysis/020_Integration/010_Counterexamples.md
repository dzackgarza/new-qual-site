...
- $f_n = (1/n) \chi_{(0, n)}$.
  ...
  ![figures/image_2021-05-21-16-38-30.png](../../../assets/figures/image_2021-05-21-16-38-30.png)

- $f_n = \chi_{(n, n+1)}$ (skateboard to infinity).
  This satisfies 2,3 but not 1, 4.

  ![figures/image_2021-05-21-16-42-08.png](../../../assets/figures/image_2021-05-21-16-42-08.png)

- $f_n = n\chi_{(0, \frac 1 n)}$.
  This satisfies 3 but not 1,2,4.

  ![figures/image_2021-05-21-16-54-38.png](../../../assets/figures/image_2021-05-21-16-54-38.png)
...
- $f_n:$ one can construct a sequence where $f_n \to 0$ in $L^1$ but is not 1,2, or 3. The construction:
  ...
  ![figures/image_2021-05-21-16-49-09.png](../../../assets/figures/image_2021-05-21-16-49-09.png)
