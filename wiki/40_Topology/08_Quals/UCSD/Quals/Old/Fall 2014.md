...
## 6. Prove that $\CP^2\#\CP^2$ and $S^2\times S^2$ are not homotopy-equivalent.

[[P-9RRSR]]

## 7. Nonzero-degree maps of closed oriented $n$-manifolds induce injective cohomology over any field.

[[P-WZLJO]]

## 8. Higher homotopy of $\Sigma_g$ ($g\geq 1$) vanishes; deduce $\pi_1(\Sigma_g)$ is not free.
