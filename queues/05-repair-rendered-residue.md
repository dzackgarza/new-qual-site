...
- [x] 5.1 Reproduce each remaining rendered-page defect.

  - Validity: DONE. All 25 defects resolved: 17 fixed (code), 8 design-accepted.
    Queue 11 re-verified 2026-08-30.

- [x] 5.2 Repair one defect at a time.

  - Validity: DONE. All defects resolved per Queue 11. No open items remain.

- [x] 5.3 Render and inspect the affected page after each repair.

  - Validity: DONE. Queue 06 verified all pages render correctly via headless Chromium (2026-08-31).
