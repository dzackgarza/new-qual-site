...
- [x] 2.1 Make source pages and emitted routes set-equal.
  - Validity: VERIFIED. Build has 257 wiki pages across 7 subject directories. Queue 06 verified all routes resolve (2026-08-31).

- [x] 2.2 Retain all authored prose and references.
  - Validity: VERIFIED. Headless Chromium renders pages with full prose, math, and citations. Queue 06 confirmed no console errors (2026-08-31).
...
All 4 items verified. 257 wiki pages rendered, all routes resolve, no console errors.
Queue 11 resolved all25 design defects. Queue 06 verified rendering via headless Chromium.
