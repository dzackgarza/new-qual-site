...
:::
::: {.solution}
<1>1. Continuous $\Rightarrow$ l.s.c. and u.s.c. Proof: if $f$ is continuous, then $f^{-1}(a,\infty)$ and $f^{-1}(-\infty,b)$ are preimages of open sets, hence open.
...
<1>4. (Part 2, $\Leftarrow$) If $\liminf_n f(x_n) \ge f(x)$ whenever $x_n \to x$, then $f$ is l.s.c. Proof: suppose $f$ were not l.s.c.: some $f^{-1}(a,\infty)$ is not open.
