...
Proof: pick $r$ with $r > 1/e$ (possible since $R > 0$); then $n^n r^n \to \infty$, so for large $n$, $n^n r^n \ge M(r)$.
<2>2. Hence $|f^{(n)}(0)| = n! |a_n| \le n! \frac{M(r)}{r^n} \le n! \frac{n^n r^n}{r^n} = n^n n!$.
Proof: combine <1>2 and <1>3.1.

<1>4. Q.E.D.
Proof: <1>3.2 gives $|f^{(n)}(0)| \le n^n n!$ for some $n > 0$.
:::
