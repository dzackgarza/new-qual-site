...
N(a + 3bi) = a^2 + 9b^2.
\]
Proof: restriction of the complex modulus squared $N(\alpha\beta) = N(\alpha)N(\beta)$.
...
Proof: integer solutions to $a^2 + 9b^2 = 1$.
...
Proof: divisors of 9 in $\mathbb{Z}_{\ge 0}$.
...
Proof: non-existence of elements of norm 3.
...
Proof: every UFD is integrally closed.
