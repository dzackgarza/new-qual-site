...
<2>2. $IJ$ absorbs ring multiplication: for any $r \in R$ and $x = \sum_{i=1}^n x_i y_i \in IJ$, $rx = \sum_{i=1}^n (rx_i) y_i \in IJ$ (since $rx_i \in I$) and $xr = \sum_{i=1}^n x_i (y_i r) \in IJ$ (since $y_i r \in J$). Proof: $I$ and $J$ are two-sided ideals.
...
Q.E.D. Proof: <1>1, <1>2, <1>3, and <1>4.
:::
