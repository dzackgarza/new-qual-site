...
Proof: irreducible factors of cyclotomic polynomials and definition of matrix order.
...
Proof: Rational Canonical Form Theorem for modules over $\mathbb{Q}[x]$.
...
Proof: $d_1 \mid d_2$ and $\deg(d_1) + \deg(d_2) = 2 + 2 = 4$.
...
Proof: $d_1 \mid d_2$ and $\deg(d_1) + \deg(d_2) = 1 + 3 = 4$.
...
Proof: single cyclic factor of degree 4.
...
G \cong P_2 \times P_3.
\]
Proof: primary decomposition of finite abelian groups.
...
Proof: classification of abelian $p$-groups.
...
Proof: direct product and Chinese Remainder Theorem.
