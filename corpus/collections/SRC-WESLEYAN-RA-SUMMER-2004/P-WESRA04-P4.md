...
- event: source-checked
  by: gpt-5.6-sol
  date: 2026-09-10
  note: Checked directly against Real Analysis section 2.3, problem 4 of the Wesleyan Preliminary Examination, August 2, 2004, in analysis_2003-2007.pdf.
...
::: problem
Let $f:[0,1]\to[0,1]$ be Lebesgue measurable. Prove that its graph
\[
...
The graph of $h$ is Borel measurable. Indeed, the map
\[
...
(\Gamma_h)_x=\{h(x)\},
\]
which has one-dimensional Lebesgue measure zero. Tonelli's theorem gives
\[
(m\times m)(\Gamma_h)
...
\]
The set $N\times[0,1]$ has product measure zero. Since the product measure in the problem is completed, every subset of this null set is measurable. Hence $\Gamma_f$ is measurable and
\[
(m\times m)(\Gamma_f)=0.
\]
Thus
