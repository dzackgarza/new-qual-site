...
Proof: $q > p > 2$, so $2, p, 2p < q$ and none is $\equiv 1 \pmod q$ (they are all $< q$ and $> 1$).
...
Proof: $|G/N_2| = 2pq/q = 2p$.
<2>2. $G/N_2$ has a normal subgroup of order $p$.
Proof: by Sylow, the number of Sylow $p$-subgroups of $G/N_2$ divides $2$ and is $\equiv 1 \pmod p$; since $p > 2$, the only such divisor is $1$, so the Sylow $p$-subgroup is normal.
<2>3. Its preimage $N_1$ in $G$ is normal of order $pq$.
Proof: the preimage of a normal subgroup under the quotient map is normal, and $|N_1| = p \cdot q = pq$.
<2>4. $N_2 \subseteq N_1$.
Proof: $N_1$ is the preimage of a subgroup of $G/N_2$, so it contains the kernel $N_2$.

<1>3. Q.E.D.
Proof: <1>1 gives $N_2$; <1>2 gives $N_1$ with $N_2 \subseteq N_1$.
:::
