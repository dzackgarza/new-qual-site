...
::: {.proof}
By <2>3, the $\delta$ of <2>2 works uniformly in $x, y$; $\eps > 0$ was arbitrary.
:::
<2>5. Q.E.D.
::: {.proof}
This proves (c).
...
::: {.proof}
Such bumps exist in $C^\infty(\RR)$ by standard constructions; $f$ is $C^\infty$ on $\RR^2$, hence differentiable on $E$ in every sense.
:::
