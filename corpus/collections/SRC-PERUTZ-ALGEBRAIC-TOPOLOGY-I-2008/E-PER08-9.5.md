...
id: E-PER08-9.5
kind: problem
title: Perutz Algebraic Topology I Exercise 9.5
classification:
  areas: [topology]
  topics: []
relations: []
...
::: {.problem}
(*) If a: A∗ → B∗ and b∗ : B∗ → C∗ are chain maps, what can we
...
complexes satisfies Verdier’s ‘octahedral axiom’ for triangulated categories.
:::
