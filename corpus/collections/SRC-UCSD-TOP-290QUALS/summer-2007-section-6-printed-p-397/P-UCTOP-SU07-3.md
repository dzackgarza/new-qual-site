...
\]
Proof: cellular homology of $\mathbb{RP}^2$.
...
\]
Proof: cellular homology of the orientable 3-manifold $\mathbb{RP}^3$.
...
\]
Proof: Künneth Theorem for product spaces over $\mathbb{Z}$.
...
Proof: <1>1 and Künneth formula algebra.
