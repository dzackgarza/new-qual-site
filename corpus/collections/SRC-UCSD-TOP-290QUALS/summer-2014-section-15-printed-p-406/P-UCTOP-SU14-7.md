...
<2>1. $f$ induces an isomorphism on all homology groups (degree $\pm 1$). Proof: by hypothesis, $f_*: H_*(M) \to H_*(N)$ is an isomorphism.
...
<1>5. Q.E.D. Proof: <1>4 shows $f_*$ is surjective.
:::
