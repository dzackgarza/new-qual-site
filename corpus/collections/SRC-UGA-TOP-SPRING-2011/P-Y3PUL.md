...
\]
::: {.proof}
abelianization of free product is direct sum of abelianizations.
:::
...
::: {.proof}
standard classification of surfaces with boundary.
:::
...
::: {.proof}
free groups contain no non-trivial elements of finite order.
:::
...
::: {.proof}
universal cover is $\mathbb{R}^2$ or $\mathbb{H}^2$, which is contractible, so $\pi_1(S)$ is torsion-free.
:::
...
::: {.proof}
deck group acting freely on contractible universal cover.
:::
