...
Proof: a map $S^n \to X \times Y$ is a pair of maps $S^n \to X$ and $S^n \to Y$, and homotopies correspond componentwise.

<1>2. $\pi_n(S^k) = 0$ for $n < k$.
Proof: any map $S^n \to S^k$ with $n < k$ is null-homotopic (cellular approximation: it factors through the $n$-skeleton of $S^k$, which is a point).

<1>3. $\pi_n(S^n) = \ZZ$.
Proof: the Hurewicz theorem identifies $\pi_n(S^n)$ with $H_n(S^n) = \ZZ$.

<1>4. Compute each factor for $n \le 3$.
<2>1. $\pi_n(S^3)$: $\pi_1 = \pi_2 = 0$, $\pi_3 = \ZZ$.
Proof: by <1>2 and <1>3.
<2>2. $\pi_n(S^4)$: $\pi_1 = \pi_2 = \pi_3 = 0$.
Proof: by <1>2, since $n < 4$ for $n \le 3$.
<2>3. $\pi_n(S^5)$: $\pi_1 = \pi_2 = \pi_3 = 0$.
Proof: by <1>2, since $n < 5$ for $n \le 3$.

<1>5. Combine.
<2>1. $\pi_1(S^3 \times S^4 \times S^5) = 0$.
Proof: $0 \times 0 \times 0$.
<2>2. $\pi_2(S^3 \times S^4 \times S^5) = 0$.
Proof: $0 \times 0 \times 0$.
<2>3. $\pi_3(S^3 \times S^4 \times S^5) = \ZZ$.
Proof: $\ZZ \times 0 \times 0$.

<1>6. Q.E.D.
Proof: $\pi_n = 0$ for $n = 1, 2$, and $\pi_3 = \ZZ$.
:::
