...
Proof: definition of Euler’s totient function.
<2>2. For any $k \in S$, we have $\gcd(n - k, n) = \gcd(k, n) = 1$, so $n - k \in S$.
Proof: properties of the Euclidean greatest common divisor.
...
Proof: partition into 2-element equivalence classes.
...
\]
Proof: multiplicativity of Euler’s totient function.
