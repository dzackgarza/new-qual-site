...
::: {.proof}
the multiplication in $R^{\mathrm{op}}$ is reversed.
:::
...
::: {.proof}
in a commutative ring, the opposite ring is the same ring.
:::

<1>5. Q.E.D.
::: {.proof}
<1>3 gives the homomorphism to $R^{\mathrm{op}}$; <1>4 gives the isomorphism to $R$ in the commutative case.
:::
:::
