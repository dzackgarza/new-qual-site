...
Proof: definition of the covariant functor $\operatorname{Hom}(M, -)$.
...
Proof: composition with zero homomorphism.
...
Proof: $\operatorname{id}_{\mathbb{Z}_2}(1) = 1 \neq 0$.
