...
Proof: counting elements of distinct prime orders.
...
Proof: characteristic subgroups of normal subgroups are normal.
...
Proof: classification of homomorphisms $\mathbb{Z}_2 \to (\mathbb{Z}/15\mathbb{Z})^\times \cong \mathbb{Z}_2 \times \mathbb{Z}_4$.
...
Proof: Correspondence Theorem and semidirect product actions.
