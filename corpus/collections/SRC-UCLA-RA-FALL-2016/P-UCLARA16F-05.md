...
id: P-UCLARA16F-05
kind: problem
title: UCLA analysis Fall 2016, Problem 5
classification:
  areas:
  - real-analysis
  topics: []
...
\]
Let $\mathcal A$ be the Borel $\sigma$-algebra on $X$. Show that $\mathcal A$ is the smallest $\sigma$-algebra on $X$ that contains all sets of the form
\[
