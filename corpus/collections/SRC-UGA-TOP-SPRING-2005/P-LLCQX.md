...
id: P-LLCQX
kind: problem
title: Homology of a torus with two parallel circles filled by disks
classification:
  areas:
  - topology
  topics:
...
- event: source-checked
  ...
  note: >-
    ...
    topology exam. The exam asks for integral homology only.
...
::: {.remark}
With the cell structure of the solution, the fundamental group is
\[
