...
\]
Proof: $|1 - a_k z| \ge 1 - a_k |z| \ge 1 - r$ and $|1+z| \le 1+|z| \le 1+r$.
...
Proof: <2>3 and Weierstrass $M$-test.
...
Proof: open mapping theorem / maximum modulus principle for non-constant analytic functions.
...
Proof: hypothesis $\overline{\mathbb{D}} \subset U$.
<2>4. $g$ is continuous at $z_0 = 1$, so $g(1) = \lim_{k\to\infty} g(a_k) = 0$.
Proof: continuity of analytic functions.
