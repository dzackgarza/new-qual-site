...
::: {.proof}
deformation retraction of $\mathbb{R}^2 \setminus \{2 \text{ points}\}$ onto wedge of 2 circles.
:::
...
::: {.proof}
homotopy equivalence of plane minus a segment with punctured plane.
:::
...
::: {.proof}
fundamental group of finite connected graph.
:::
...
::: {.proof}
stereographic projection and deformation retraction.
:::
...
::: {.proof}
deformation retraction onto 1-skeleton.
:::
...
::: {.proof}
covering space classification for $\mathbb{RP}^2$.
:::
...
::: {.proof}
suspension of a circle is homeomorphic to $S^2$.
:::
...
\]
::: {.proof}
deformation retraction of unknot complement in $\mathbb{R}^3$.
:::
...
\]
::: {.proof}
Wirtinger presentation / torus fiber structure of the Hopf link complement.
:::
