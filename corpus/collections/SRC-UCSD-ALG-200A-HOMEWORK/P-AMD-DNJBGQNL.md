...
Proof: definition of inner automorphisms.
...
\]
Proof: $\varphi$ is a group homomorphism.
...
Proof: normal subgroup criterion.
...
Proof: $\ker(g \mapsto \gamma_g) = Z(G) = \{1\}$.
...
Proof: centerless group centralizer property.
...
Proof: automorphisms preserve normality, isomorphism types, and centralizers.
...
Proof: Burnside's Theorem on centerless normal subgroups in automorphism groups.
