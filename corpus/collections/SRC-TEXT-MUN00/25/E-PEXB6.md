...
Proof: star-shaped spaces are path connected.
...
Proof: star-shaped open balls are connected.
...
Proof: components in $B(z, \varepsilon) \cap T$ are 1-dimensional slices with empty interior.
...
Proof: definition of double broom / crossed comb space.
...
Proof: union of path-connected spaces with non-empty intersection.
...
Proof: isolation of transversal rational rays.
