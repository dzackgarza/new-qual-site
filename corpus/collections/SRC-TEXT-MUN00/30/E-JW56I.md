...
- It is not separable. The closure of any countable subset \(D\subset S_\Omega\) is bounded below some countable ordinal \(eta<\Omega\), since \(\sup D<\Omega\). Thus \(D\) cannot be dense.
