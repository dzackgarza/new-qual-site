...
::: {.proof}
topological closure definition.
:::
...
\]
::: {.proof}
definition of finite intersections.
:::
...
::: {.proof}
closure of $\mathcal{B}$ under finite intersections.
:::
...
::: {.proof}
Axiom of Choice and hypothesis.
:::
...
::: {.proof}
closed sets contain all cluster points of their sub-tails.
:::
