...
Proof: connected sum of polygonal schemas for $P^2$ ($c^2$) and $T$ ($aba^{-1}b^{-1}$).
...
\]
Proof: quotient of free abelian groups.
...
Proof: Dyck's Theorem / classification invariants.
