...
\]
Proof: derivative of geometric series for $|x| < 1$.
...
Proof: $r = \sup_{x \in K} |x| < 1$ by compactness of $K$.
...
\]
Proof: triangle inequality for infinite series.
...
Proof: definition of uniform metric $d_u(f, g) = \sup |f - g|$.
...
Proof: divergence of $\frac{1}{(1-x)^2}$ at the boundary $x = 1$.
...
Proof: infinite uniform distance for all $n$.
