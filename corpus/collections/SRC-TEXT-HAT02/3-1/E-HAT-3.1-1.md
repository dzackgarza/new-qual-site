...
Proof: every abelian group is a quotient of a free abelian group, and subgroups of free abelian groups are free.
...
\]
Proof: comparison theorem for projective resolutions.
...
Proof: functoriality of $\operatorname{Hom}(-, G)$.
...
\]
Proof: quotient map between cokernels.
...
Proof: chain homotopy induces the zero map on homology/cohomology.
...
Proof: composition of chain maps.
...
Proof: covariance of $\operatorname{Hom}(F_k, -)$.
...
Proof: associativity of map composition.
...
Proof: composition of post-composition maps.
