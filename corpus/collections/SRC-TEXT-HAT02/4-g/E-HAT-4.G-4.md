...
Proof: statement of the proposition.
...
Proof: a subcomplex of a CW complex has a regular neighborhood that deformation retracts onto it.
...
Proof: the regular neighborhoods can be chosen so that intersections of neighborhoods retract onto intersections of subcomplexes.
...
Proof: <1>3 is exactly the corollary's statement.
