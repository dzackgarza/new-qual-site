...
Proof: definition of the total space of a complex of spaces.
...
Proof: composition of homeomorphisms along paths in $\Gamma$.
...
Proof: interior of edge has no quotient identifications.
...
Proof: direct Cartesian product.
...
Proof: open star basis for 1-complexes.
...
Proof: product of homeomorphisms.
...
Proof: gluing local product charts along the identity at the vertex.
