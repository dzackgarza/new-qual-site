...
Proof: definition of orientation local coefficients.
...
Proof: Poincaré Duality Theorem with local coefficients.
...
Proof: standard homology computation for nonorientable surfaces.
...
\end{cases}
\]
Proof: Poincaré Duality and <1>2.
...
Proof: twisted cellular boundary formulas.
