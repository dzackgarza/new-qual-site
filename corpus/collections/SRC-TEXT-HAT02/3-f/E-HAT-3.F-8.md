...
Proof: definition of a Moore space.
...
Proof: <1>1 and the universal coefficient theorem.
...
Proof: the long exact sequence in cohomology from a short exact sequence of coefficients.
...
Proof: <1>2 and <1>3 (all other terms vanish).
