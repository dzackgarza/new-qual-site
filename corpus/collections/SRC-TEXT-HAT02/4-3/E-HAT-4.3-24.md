...
Proof: definition of relative homotopy between lifts.
...
Proof: standard obstruction theory for extending sections of fibrations.
<2>2. This defines an obstruction cocycle:
\[
c^{n+1} \in C^{n+1}(W \times I, Y; \pi_n F).
\]
Proof: assignment of boundary homotopy classes to $(n+1)$-cells.
...
\]
Proof: excision and suspension isomorphism in relative cohomology.
