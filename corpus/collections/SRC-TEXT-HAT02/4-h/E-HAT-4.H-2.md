...
Proof: definition of adjunction space / pushout.
...
Proof: test data for the Homotopy Extension Property.
...
Proof: pushout identification $j(f(a)) = q(i(a))$ in $P$.
...
\]
Proof: definition of cofibration for $A \hookrightarrow X$.
