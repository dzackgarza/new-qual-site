...
Proof: definition of an H-space.
<2>2. Let $f, g: [0, 1] \to X$ be based loops ($f(0) = f(1) = g(0) = g(1) = e$). Proof: setup.
...
\]
Proof: definitions of concatenation and induced pointwise multiplication.
...
Proof: identity element properties in the fundamental group.
...
Proof: homotopy invariance of the induced map $\mu_*$.
<2>2. For $t \in [0, 1/2]$:
\[
((f * c_e) \odot (c_e * g))(t) = \mu((f * c_e)(t), (c_e * g)(t)) = \mu(f(2t), e) \simeq f(2t) = (f * g)(t).
\]
Proof: definition of $*$ and unit axiom $\mu(x, e) \simeq x$.
<2>3. For $t \in [1/2, 1]$:
\[
((f * c_e) \odot (c_e * g))(t) = \mu((f * c_e)(t), (c_e * g)(t)) = \mu(e, g(2t - 1)) \simeq g(2t - 1) = (f * g)(t).
\]
Proof: definition of $*$ and unit axiom $\mu(e, y) \simeq y$.
