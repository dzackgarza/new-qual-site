...
\]
Proof: definition of degree via cohomology.
...
Proof: Poincaré duality pairing on closed orientable surfaces.
...
Proof: pinch map collapsing one connected summand to a point.
...
Thus $\deg(f) = +1$.
Proof: local degree formula for degree of smooth/continuous maps.
