...
Show briefly that all but one of the capital letters of the alphabet is either contractible or deformation retracts onto a subspace homeomorphic to $O$. Show that the letters fall into exactly three homotopy types. How many homeomorphism types are there?
