...
::: {.problem}
Let $K\subset S^3$ be the left-handed trefoil knot. This exercise compares the following groups:
...
3. Let $\operatorname{Sym}^3_0(\mathbb C)$ be the unordered triples $\{a,b,c\}$ with $a+b+c=0$. Show that
   \[
