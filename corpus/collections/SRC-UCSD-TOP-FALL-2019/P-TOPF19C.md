...
\]
::: {.proof}
standard cellular homology of $\mathbb{RP}^2$ ($C_2 \xrightarrow{2} C_1 \xrightarrow{0} C_0$).
:::
...
\]
::: {.proof}
Künneth Theorem for topological spaces.
:::
...
::: {.proof}
connected space has $H_0 \cong \mathbb{Z}$.
:::
<2>2. **Degree $n = 1$:**
\[
...
::: {.proof}
$\mathbb{Z}_2 \otimes \mathbb{Z}_2 \cong \mathbb{Z}_2$ and $\mathbb{Z}$ is torsion-free.
:::
<2>4. **Degree $n = 3$:**
...
::: {.proof}
$\operatorname{Tor}_1^{\mathbb{Z}}(\mathbb{Z}_m, \mathbb{Z}_n) \cong \mathbb{Z}_{\gcd(m,n)}$.
:::
<2>5. **Degree $n \ge 4$:**
...
::: {.proof}
dimension and Künneth vanishings.
:::
