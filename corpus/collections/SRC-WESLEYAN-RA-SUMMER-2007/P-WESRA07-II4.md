...
- event: source-checked
  by: gpt-5.6-sol
  date: 2026-09-14
  note: Checked against Part II, item 4 in the deterministic MinerU Flash extraction assets/attachments/analysis_2003-2007_extracted.md.
...
By the assumed translation invariance,
\[
\mu(I+kt)=\mu(I)
\]
...
=N\mu(I),
\]
which contradicts finiteness of $\mu(\mathbb R)$ as $N\to\infty$.
Hence
\[
\mu(I)=0.
\]
...
\]
Thus $\mu(\mathbb R)=0$, and consequently every Borel set has measure zero.
Therefore
\[
\boxed{\mu=0}.
\]
