...
\]
::: {.proof}
leading monomials under lex order.
:::
...
::: {.proof}
Buchberger's algorithm and coprimality criterion.
:::
...
::: {.proof}
divisibility condition for monomial ideals.
:::
...
::: {.proof}
listing remaining square-free monomials.
:::
