...
<1>5. Conclude (2).
::: {.proof}
by <1>3 and <1>4, the simple functions from <1>2 can be chosen with Borel level sets (replace each level set by its Borel part), and their pointwise limit is Borel and equals $f$ a.e. <1>6. Q.E.D.
:::
:::
