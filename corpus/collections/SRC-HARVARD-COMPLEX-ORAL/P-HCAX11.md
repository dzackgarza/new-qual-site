...
Proof: definition of the punctured disk and an annulus.
...
Proof: $f(\mathbb{D}^*) = A \subset B(0, R)$.
...
Proof: limits of sequences in $A$ lie in the closure $\overline{A}$.
...
Proof: non-constant holomorphic maps are open and locally finite-to-one.
...
Proof: an open neighborhood of a boundary point contains points in the exterior.
