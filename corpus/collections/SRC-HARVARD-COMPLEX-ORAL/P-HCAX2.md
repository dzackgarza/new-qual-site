...
::: {.proof}
the upper half-plane is conformally equivalent to the unit disk.
:::
...
::: {.proof}
<1>3–<1>5 (if $g$ is constant then $\tilde f$ is constant, so $f = j \circ \tilde f$ is constant).
:::
