...
::: {.proof}
Hurewicz theorem and UCT. <2>7. Thus $\bar{f}^*(\alpha) = \alpha$, where $\alpha \in H^1(\mathbb{RP}^k; \mathbb{Z}_2)$ is the non-zero generator.
:::
::: {.proof}
<2>5 and <2>6.
:::
...
\]
::: {.proof}
<2>7 and cup product preservation.
:::
