...
\]
Proof: polar integration of $1/r$.
...
\]
Proof: Tonelli's Theorem for non-negative measurable functions and finiteness of $\mu$.
...
Proof: a locally integrable function is finite almost everywhere.
...
Proof: <1>1 applied to the compact set $Q_n$.
...
Proof: Fubini–Tonelli Theorem on product measure spaces.
...
Proof: countable unions of measure zero sets have measure zero.
...
Proof: the family of parallel lines carrying positive $\mu$-measure is at most countable.
...
Proof: <1>2 applied to the four boundary segments of $\partial S$.
...
\]
Proof: Fubini's Theorem on product space $\partial S \times \mathbb{C}$.
...
\]
Proof: Lebesgue integration of characteristic functions.
