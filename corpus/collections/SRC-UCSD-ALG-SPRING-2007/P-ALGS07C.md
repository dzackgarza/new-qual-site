...
Proof: definition of $\mathbb{R}[x]$-module isomorphism.
...
Proof: Structure Theorem for finitely generated modules over PIDs.
...
Proof: Fundamental Theorem of Algebra and complex conjugation.
...
Proof: elementary divisors $(x-\lambda_1), (x-\lambda_2), (x-\lambda_3)$.
...
Proof: elementary divisors $(x-\lambda_1)^2, (x-\lambda_2)$.
...
Proof: elementary divisor $(x-\lambda)^3$.
...
Proof: elementary divisors $(x^2+ax+b), (x-\lambda)$.
