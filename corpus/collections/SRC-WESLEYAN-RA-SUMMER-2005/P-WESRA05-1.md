...
Since $X$ has five points, the number $k$ of nonempty atoms may be any integer from $1$ through $5$.
Each value occurs, by choosing a partition of $X$ into $k$ nonempty blocks.
Hence the possible cardinalities are
\[
\boxed{2,4,8,16,32.}
\]
:::
