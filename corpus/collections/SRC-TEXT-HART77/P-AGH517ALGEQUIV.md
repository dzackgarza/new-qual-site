...
Note. The theorem of Néron and Severi states that the group of divisors modulo algebraic equivalence, called the Néron-Severi group, is a finitely generated abelian group. Over $\CC$ this can be proved easily by transcendental methods (App. B, §5) or as in (Ex. 1.8) below. Over a field of arbitrary characteristic, see Lang and Néron [1] for a proof, and Hartshorne [6] for further discussion. Since $\Num X$ is a quotient of the Néron-Severi group, it is also finitely generated, and hence free, since it is torsion-free by construction.
:::
