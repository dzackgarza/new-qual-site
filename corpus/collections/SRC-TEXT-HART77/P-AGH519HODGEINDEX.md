...
b. Now let $X$ be a product of two curves $X=C \times C^{\prime}$. Let $l=C \times \mathrm{pt}$, and $m=\mathrm{pt} \times C^{\prime}$. For any divisor $D$ on $X$, let $a=D . l$, $b=D . m$. Then we say $D$ has type $(a, b)$. If $D$ has type $(a, b)$, with $a, b \in \ZZ$, show that
\[
D^2 \leqslant 2 a b ,
\]
