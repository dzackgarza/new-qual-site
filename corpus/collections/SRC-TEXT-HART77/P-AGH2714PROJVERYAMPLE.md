...
b. Let $f: X \to Y$ be a morphism of finite type, let $\mcl$ be an ample invertible sheaf on $X$, and let $\mcs$ be a sheaf of graded $\OO_X\dash$algebras satisfying the usual finiteness condition.
