...
::: {.problem}
Let $X$ be a noetherian scheme, and suppose that every coherent sheaf on $X$ is a quotient of a locally free sheaf.
...
Hint: Show $\mathcal{E}xt^i(\wait, \mcg)$ is coeffaceable for $i>0$.
:::
