...
2. Show that the quadric surfaces $Q_1 : xy = zw$ and $Q_2 : xy = z^2$ in $\PP^3$ are normal.
3. Show that the cuspidal cubic $y^2 = x^3$ in $\AA^2$ is not normal.
4. If $Y$ is affine, show that $Y$ is normal if and only if $A(Y)$ is integrally closed.
5. Let $Y$ be an affine variety.
