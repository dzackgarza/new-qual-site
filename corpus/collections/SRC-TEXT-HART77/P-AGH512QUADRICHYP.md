...
3. Assume $r \geq 2$, and let $Q$ be the quadric hypersurface in $\PP^n$ defined by $f$. Show that the singular locus $Z = \Sing Q$ of $Q$ is a linear variety of dimension $n - r - 1$. In particular, $Q$ is nonsingular if and only if $r = n$.
