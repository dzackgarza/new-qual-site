...
in $k$.
  ...
  Hint: Reduce to the case where $D$ and $E$ are nonsingular curves meeting transversally. Then consider the analogous map $c: \Pic D \rightarrow H^1\left(D, \Omega_D\right)$, and the fact (III, Ex. 7.4) that $c(\text{point})$ goes to 1 under the natural isomorphism of $H^1\left(D, \Omega_D\right)$ with $k$.
