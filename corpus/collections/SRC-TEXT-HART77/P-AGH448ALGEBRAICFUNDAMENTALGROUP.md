...
Note: More generally, Grothendieck has shown (SGA 1, X, 2.6) that the algebraic fundamental group of any curve of genus $g$ is isomorphic to a quotient of the completion, with respect to subgroups of finite index, of the ordinary topological fundamental group of a compact Riemann surface of genus $g$.
:::
