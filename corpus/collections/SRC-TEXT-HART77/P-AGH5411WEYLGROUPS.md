...
a. The Weyl group $\mathbf{A}_n$ is defined using the diagram of $n-1$ points, each joined to the next. Show that it is isomorphic to the symmetric group $\Sigma_n$ as follows:
