...
::: problem
Let $Y$ be a variety of dimension $r$ in $\PP^n$, with Hilbert polynomial $P_Y$. Define the *arithmetic genus* of $Y$ to be
$$
...
5. Let $Y^r \subseteq \PP^n$ and $Z^s \subseteq \PP^m$ be projective varieties, and embed $Y \times Z \subseteq \PP^n \times \PP^m \to \PP^N$ by the Segre embedding. Show that
$$
