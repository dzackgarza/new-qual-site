...
id: P-TOPF02C
kind: problem
title: A Moore space $M(\mathbb Z_4,2)$ and the homology of $\mathbb{RP}^2\times M(\mathbb Z_4,2)$
classification:
  areas:
  - topology
  topics:
...
::: {.solution}
<1>1. Part (a): Construction of Moore space $Y = M(\mathbb{Z}_4, 2)$: <2>1. Define $Y = S^2 \cup_f e^3$, where the attaching map $f: \partial e^3 = S^2 \to S^2$ has topological degree $4$.
::: {.proof}
...
<1>2. Part (b)(i): Integer homology $H_*(\mathbb{RP}^2 \times Y; \mathbb{Z})$: <2>1. Recall $H_*(\mathbb{RP}^2; \mathbb{Z}) = (\mathbb{Z}, \mathbb{Z}_2, 0, \dots)$.
::: {.proof}
...
<1>3. Part (b)(ii): Mod 2 homology $H_*(\mathbb{RP}^2 \times Y; \mathbb{Z}_2)$: <2>1. By the Universal Coefficient Theorem, $H_*(\mathbb{RP}^2; \mathbb{Z}_2) = (\mathbb{Z}_2, \mathbb{Z}_2, \mathbb{Z}_2, 0, \dots)$ and $H_*(Y; \mathbb{Z}_2) = (\mathbb{Z}_2, 0, \mathbb{Z}_2, \mathbb{Z}_2, 0, \dots)$.
::: {.proof}
...
<1>4. Part (b)(iii): Integer cohomology $H^*(\mathbb{RP}^2 \times Y; \mathbb{Z})$: <2>1. By the Universal Coefficient Theorem for cohomology, $H^n(X; \mathbb{Z}) \cong \operatorname{Free}(H_n(X)) \oplus \operatorname{Tors}(H_{n-1}(X))$:
...
<1>5. Conclusion: $Y = S^2 \cup_4 e^3$, and all homology/cohomology groups are determined.
Q.E.D.
::: {.proof}
<1>1 through <1>4.
:::
