...
Proof: definition of Moore space.
...
Proof: degree of attaching map on 2-cells.
...
\]
Proof: homology of cellular chain complex.
...
- $n \ge 4$: $H_n = 0$.
Proof: Künneth Theorem for integral homology.
...
- $n \ge 5$: $H^n = 0$.
Proof: UCT for cohomology with coefficients in $\mathbb{Z}$.
