...
\]
Proof: factoring $(x-1)^3 + (x-1)^2 = (x-1)^2(x-1+1) = x(x-1)^2$.
...
Proof: Gauss's Lemma for polynomials over UFDs.
...
Proof: quotient of a domain by a prime ideal is a domain.
...
Proof: calculus and Taylor expansion around $(1, 0)$ and $(0, 0)$.
...
Proof: definition of integral element.
...
Proof: polynomial rings over fields are integrally closed.
