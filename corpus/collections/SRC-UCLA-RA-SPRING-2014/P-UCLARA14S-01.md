...
::: {.problem}
Let $(X,\mathcal A,\mu)$ be a $\sigma$-finite measure space. For $t\in\mathbb R$, let $e_t$ be the characteristic function of $(t,\infty)$. Prove that for measurable $f,g:X\to\mathbb R$,
\[
