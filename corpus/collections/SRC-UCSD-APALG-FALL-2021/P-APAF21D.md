...
::: {.proof}
$\|A^H A\|_2 = \sigma_{\max}(A^H A) = \sigma_{\max}(A)^2 = \|A\|_2^2 = \|A^H\|_2 \|A\|_2$ (using <1>1 and the fact that the singular values of $A^H A$ are the squares of the singular values of $A$).
:::
...
<1>3. Q.E.D.
::: {.proof}
<1>2 (a), <1>1–<1>2 (b), <1>3 (c), and <1>1–<1>2 (d).
:::
:::
