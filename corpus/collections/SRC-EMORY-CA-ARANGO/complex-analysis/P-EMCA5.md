...
::: {.proof}
statement of the Schwarz lemma.
:::
...
::: {.proof}
the Möbius automorphisms sending $a \mapsto 0$ and $f(a) \mapsto 0$.
:::
...
::: {.proof}
<1>1 and <1>2 ($\varphi_a^{-1}(0) = a$ and $\psi_{f(a)}(f(a)) = 0$).
:::
...
::: {.proof}
compute the derivatives of the Möbius maps.
:::
