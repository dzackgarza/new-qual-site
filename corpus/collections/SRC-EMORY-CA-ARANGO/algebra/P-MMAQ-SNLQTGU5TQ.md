...
Proof: equivalent to the Axiom of Choice.
...
Proof: setup linear dependence relation.
...
Proof: total ordering of finite subsets of chains.
...
Proof: Zorn's Lemma applied to <1>2 and <1>3.
<2>2. Since $B \in \mathcal{P}$, $B$ is linearly independent.
Proof: definition of $\mathcal{P}$.
