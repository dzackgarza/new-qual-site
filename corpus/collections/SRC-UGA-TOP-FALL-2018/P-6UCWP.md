...
\chi(C) = \chi(S^1) = 0.
\]
Proof: homotopy invariance of Euler characteristic.
...
Proof: contractibility of closed intervals.
...
Proof: Euler characteristic of quotient cell complexes.
...
Proof: classification theorem for compact 2-manifolds with boundary.
...
Proof: direct topological construction by gluing.
...
Proof: quotient of a connected space is connected.
