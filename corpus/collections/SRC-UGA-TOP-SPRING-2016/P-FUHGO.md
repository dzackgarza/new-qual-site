...
::: {.proof}
standard presentation of the fundamental group of a genus-$2$ surface.
:::
...
::: {.proof}
$H_1(\Sigma_2) = \pi_1(\Sigma_2)^{\text{ab}} = \ZZ^4$ (free abelian on $a_1, b_1, a_2, b_2$), and the image of $[a_1, b_1]$ in the abelianization is $a_1 + b_1 - a_1 - b_1 = 0$, so $[a_1, b_1]$ is nullhomologous.
:::
