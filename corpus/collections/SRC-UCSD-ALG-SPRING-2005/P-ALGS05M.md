...
Proof: linear algebra over $\mathbb{Q}$.
...
Proof: correspondence between maximal submodules and simple quotients.
...
Proof: rank and linear independence in $\mathbb{Q}^n$.
