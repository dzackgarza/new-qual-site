...
\]
Proof: diagonal entries in the standard permutation basis are 1 for fixed points and 0 otherwise.
...
\]
Proof: definition of character inner product.
...
\]
Proof: product of fixed point sets.
...
\]
Proof: Part (a) applied to the set $\mathcal{F} \times \mathcal{F}$.
...
Proof: for any $(f_1, f_2)$, choose $\gamma \in \Gamma$ with $\gamma f_1 = f_0$; then $\gamma(f_1, f_2) = (f_0, \gamma f_2)$.
...
Proof: stabilizer property of $f_0$.
...
\]
Proof: definition of double cosets $H \tau_i H$.
