...
::: {.proof}
<1>2 (a connected subset of $U$ containing $x$ lies in the component $C$).
:::
...
::: {.proof}
$p^{-1}(C)$ is a union of connected components of $p^{-1}(V)$ (each component of $p^{-1}(V)$ maps into a single component of $V$).
:::
...
::: {.proof}
<1>4 and the definition of quotient map.
:::
