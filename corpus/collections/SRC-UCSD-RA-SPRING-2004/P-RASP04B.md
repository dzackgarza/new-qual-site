...
Proof: $\int_0^\infty e^{-ax} x^m\,dx = \frac{m!}{a^{m+1}}$ with $a = 2$, $m = 2n+1$.
...
Proof: using the given formula (or $\int_0^\infty e^{-u}\sin u\,du = \frac{1}{1^2 + 1} = \frac{1}{2}$).
