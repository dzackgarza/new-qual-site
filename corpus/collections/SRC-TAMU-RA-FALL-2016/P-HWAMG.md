...
\]
::: {.proof}
$\omega_f(x) > 0 \iff \exists n \ge 1 \text{ with } \omega_f(x) \ge 1/n$.
:::
...
::: {.proof}
complement of an $F_\sigma$ set is $G_\delta$.
:::
...
::: {.proof}
singletons have empty interior in $[0, 1]$.
:::
...
::: {.proof}
Baire Category Theorem on complete metric spaces.
:::
