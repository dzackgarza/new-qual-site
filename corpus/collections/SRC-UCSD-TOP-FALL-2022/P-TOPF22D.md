...
Proof: covering space theory for compact base with finite fiber.
...
Proof: Poincaré Duality and Universal Coefficient Theorem.
...
\]
Proof: trace formula on homology.
...
Proof: $\deg(g) = +1$ defines orientation-preserving homeomorphisms.
...
Proof: orientability of quotient manifolds.
