...
::: {.problem}
(March 2013) LetG be a group, letN⊆G be a normal subgroup, and suppose that [G :N] = 42, where [G :N] denotes the index ofN inG. Prove thatx42∈N for everyx∈G. ( Suggestion: Consider the quotient group G/N.)
:::
