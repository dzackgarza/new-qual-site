...
::: {.problem}
(January 2009)  (a) Prove that f(X) =X 4 +X 2 + 1 is reducible in the polynomial ring F2[X], where F2 ={0, 1} is the ﬁeld of two elements. (b) Prove that g(X) = X 3 + 2X 2 + 2X + 3 is irreducible in the polynomial ring F5[X], where F5 ={0, 1, 2, 3, 4} is the ﬁeld of ﬁve elements.
:::
