...
::: {.problem}
(March 2007) Let p,q≥ 2 be prime numbers, and let G be a group of order|G| =pq. Let H ⊊G be a proper subgroup (i.e., H is a subgroup but is not the full group G). Prove that H is cyclic.
:::
