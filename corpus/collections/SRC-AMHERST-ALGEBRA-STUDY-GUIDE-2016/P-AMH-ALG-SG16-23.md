...
::: {.problem}
(February 2008) Let φ :R→S be a ring homomorphism. Let I⊆R be an ideal of R, and set J ={x∈I|φ(x) = 0S}, where 0S denotes the zero element of S. Prove that J is an ideal of R.
:::
