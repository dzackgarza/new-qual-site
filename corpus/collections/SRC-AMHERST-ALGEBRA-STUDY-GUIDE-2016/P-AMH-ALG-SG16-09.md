...
::: {.problem}
(January 2012) Let G and H be groups. Recall that a homomorphism φ : G→ H is said to be trivial if φ(g) = eH for all g∈ G. If |G| = 144 and |H| = 25, prove that any homomorphism φ :G→H is trivial.
:::
