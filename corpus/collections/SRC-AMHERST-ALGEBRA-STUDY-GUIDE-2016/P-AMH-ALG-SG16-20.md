...
::: {.problem}
(March 2015) LetR = Z[x] be the ring of polynomials (in one variable) with integer coeﬃcients. Note that the constant polynomial 6 and the degree one polynomial x + 1 are both elements of R. Deﬁne I ={6f + (x + 1)g|f,g ∈R}. Prove that I is an ideal of R.
:::
