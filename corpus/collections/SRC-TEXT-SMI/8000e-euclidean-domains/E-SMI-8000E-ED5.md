...
Proof: setup; $R$ is Euclidean with size function $N$.
...
Proof: $a_{1j}=q_j a_{11}$, subtract $q_j$ times column $1$ from column $j$; similarly for rows.
...
Proof: <1>2 and <1>3 (the process terminates).
