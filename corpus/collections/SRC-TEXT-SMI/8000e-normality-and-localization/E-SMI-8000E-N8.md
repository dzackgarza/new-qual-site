...
Proof: localization of an integral domain at a prime ideal.
...
Proof: Kaplansky's Theorem on UFD characterization.
...
Proof: correspondence of prime ideals under localization.
...
Proof: primality of $\mathfrak{p}$ and UFD property of $R$.
...
Proof: prime element verification.
