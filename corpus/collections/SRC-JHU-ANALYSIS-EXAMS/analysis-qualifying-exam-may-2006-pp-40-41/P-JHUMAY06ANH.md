...
\]
Proof: <2>3, <2>4, and additivity of the Lebesgue integral.
<2>6. Thus $f \in L^p(I)$ for every $p \in (1, 2)$.
Proof: $\int_I |f|^p\,dx < \infty$.
...
Proof: exponent addition $(1-\theta)p + \theta p = p$.
