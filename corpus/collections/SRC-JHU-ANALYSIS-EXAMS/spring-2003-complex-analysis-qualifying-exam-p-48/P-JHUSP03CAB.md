...
id: P-JHUSP03CAB
kind: problem
title: A second zero of a disk self-map is bounded away from the origin
classification:
  areas:
  - complex-analysis
  topics:
...
Schwarz's lemma applied to $f:\Delta\to\Delta$ gives $|f(z)|\le |z|$, so
...
::: proof
Apply the Schwarz-Pick inequality to $g$ at the two points $0$ and $w$:
$$
