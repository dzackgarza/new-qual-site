...
Proof: <1>1 and the fact that $|z|(\log(1/|z|))^{100} \to 0$ as $|z| \to 0$ (the logarithm grows slower than any negative power).
...
Proof: <1>2; a function with $|f(z)| = o(1/|z|)$ has a removable singularity.
...
Proof: <1>1 and the boundary condition.

<1>3. This is exactly $f = \alpha z^n$ with $n = 0$.
Proof: <1>2.

<1>4. Q.E.D.
Proof: <1>3 (a), <1>5 (b), <1>3 (c).
:::
