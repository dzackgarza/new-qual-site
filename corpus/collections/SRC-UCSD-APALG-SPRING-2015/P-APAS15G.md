...
\]
Proof: lex term ordering with $y > x$.
...
Proof: Buchberger's Coprime Criterion.
...
G = \{y^2 + xy, \, x^2\}.
\]
Proof: definition of reduced Gröbner basis.
...
Proof: Elimination Theorem for lex orders.
...
\mathcal{B} = \{1, \, x, \, y, \, xy\}.
\]
Proof: standard monomial basis theorem for polynomial quotient rings.
