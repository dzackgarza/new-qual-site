...
Proof: definition of the modulus of $A$.

<1>2. The singular values of $A$ are the nonnegative square roots of the eigenvalues of $A^H A$.
Proof: definition of singular values.

<1>3. The eigenvalues of $|A| = (A^H A)^{1/2}$ are the square roots of the eigenvalues of $A^H A$.
Proof: if $A^H A$ has eigenvalues $\lambda_i \ge 0$ (it is positive semidefinite), then $(A^H A)^{1/2}$ has eigenvalues $\sqrt{\lambda_i}$.
...
Proof: <1>1 plus the fact that both have $n$ eigenvalues counted with multiplicity, and the zero eigenvalue has the same multiplicity in both (equal to $n$ minus the number of nonzero eigenvalues).

<1>3. $|A| = (A^H A)^{1/2}$ and $|A^H| = (A A^H)^{1/2}$.
Proof: definition, since $(A^H)^H A^H = A A^H$.
...
Proof: two Hermitian matrices are unitarily similar iff they have the same eigenvalues (both are unitarily diagonalizable with the same diagonal).

<1>6. Q.E.D.
Proof: <1>4 (part (a)) and <1>5 (part (b)).
:::
