...
Proof: prime and irreducible elements coincide in UFDs.
<2>2. **Case 1: $(x) \cap S \neq \emptyset$.**
...
Proof: definition of units in localization.
...
Proof: definition of irreducible element.
...
Proof: factorization in $R$ maps to factorization in $S^{-1}R$.
...
Proof: factoring the numerator in $R$.
...
Proof: localization preserves primality for primes disjoint from $S$.
<2>3. Since every non-zero non-unit factors into irreducibles and every irreducible is prime, $S^{-1}R$ is a UFD.
Proof: standard criterion for unique factorization domains.
