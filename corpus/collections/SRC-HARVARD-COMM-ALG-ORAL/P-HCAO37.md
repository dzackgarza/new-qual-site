...
::: {.proof}
for any $s \in S$, surjectivity gives $r \in R$ with $\phi(r) = s$, so $s = \phi(r) = \phi(r \cdot 1_R) = r \cdot \phi(1_R) = r \cdot 1_S$.
:::
...
::: {.proof}
a ring homomorphism is finite iff the target is a finitely generated module over the source.
:::
