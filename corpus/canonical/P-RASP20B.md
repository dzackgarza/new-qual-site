...
::: problem
There are three sub-problems; all of them are calculation type. Justify your calculations.

(1) Let $f \in L^\infty(\mathbb{R})$ and $g \in L^1(\mathbb{R})$. Assume $f$ is continuous at $x = 1$ with $f(1) = \pi$, and $g \geq 0$ on $\mathbb{R}$ with $\|g\|_{L^1(\mathbb{R})} = 2$. Calculate
$$
