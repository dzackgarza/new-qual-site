...
::: problem
For each integer $k > 0$ denote by $\Delta_k(j) = [j 2^{-k}, (j+1) 2^{-k})]$ where $j \in \mathbb{Z}$, the dyadic rational interval of length $2^{-k}$ starting at $j 2^{-k}$. Let $f \in L^1(\mathbb{R})$, and define
$$
