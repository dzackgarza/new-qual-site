...
(c) For any $A \in M_n$, define (i) the field of values $F(A)$; (ii) the spectral radius $\rho(A)$; and (iii) the numerical radius $\omega(A)$. Prove that $\rho(A) \le \omega(A) \le \sigma_1(A)$.
:::
