...
::: problem
Answer true or false. For true statements give a brief justification; for false statements give a counterexample.
...
3. Suppose $(\Omega, \mathcal{B}, \mu)$ is a measure space, $\Omega_n \in \mathcal{B}$ with $\Omega_n \uparrow \Omega$ and $\mu(\Omega_n) < \infty$ for all $n$. If $f : \Omega \to \mathbb{C}$ is measurable such that $\sup_{n \in \mathbb{N}} \int_{\Omega_n} f \mathbf{1}_{|f| \leq n} g \, d\mu < \infty$ for all $g \in L^2(\mu)$, then $f \in L^2(\mu)$.
:::