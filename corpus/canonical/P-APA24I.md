...
::: problem
Let $k$ be a field and let $I \subseteq k[x_1, \ldots, x_n]$ be an ideal. Fix a monomial order $<$ and let $G = \{g_1, \ldots, g_r\}$ be a Gröbner basis of $I$ with respect to $<$. Consider the set of monomials
\[
...
(b) If $G$ is a basis of $I$ which is not necessarily Gröbner, does the set $\mathcal{M}$ necessarily span $k[x_1, \ldots, x_n]/I$? Prove or give a counterexample.
:::
