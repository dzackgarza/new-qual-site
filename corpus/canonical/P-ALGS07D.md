...
(a) Show that there exist $a_1, \ldots, a_k$ such that
$$\mathbb{C}[x]/\langle x^n \rangle \otimes_{\mathbb{C}[x]} \mathbb{C}[x]/\langle x^m \rangle \cong \bigoplus_{i=1}^{k} \mathbb{C}[x]/(x^{a_i}).$$
