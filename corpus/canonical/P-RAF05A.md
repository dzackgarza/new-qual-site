...
(a) Let $\{h_j\}$ be a sequence of real-valued functions in $L^1(\mu)$ such that $h_1 \geq h_2 \geq \cdots \to 0$.
Then $\lim_{j \to \infty} \int h_j \, d\mu = 0$.
...
Then there exists $\varepsilon > 0$, $j_0 \in \mathbb{N}$, and $f_0 \in F_{j_0}$ such that $\sup_{x \in [0,1]} |f(x) - f_0(x)| < \varepsilon$ for $f \in F_{j_0}$.
:::
