...
(b) Find the decomposition of the Kronecker product $A^{(1,4)}\otimes A^{(1,2^2)}$ as a sum of irreducible representations of $S_5$.

(c) Find the decomposition of $A^{(1,2)}\times A^{(1,3)}\uparrow_{S_3\times S_4}^{S_7}$ as a sum of irreducible representations of $S_7$.
:::
