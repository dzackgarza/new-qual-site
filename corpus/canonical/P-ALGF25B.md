...
::: problem
Suppose $G$ is a finite group. Let $\operatorname{Syl}_p(G)$ be the set of all Sylow $p$-subgroups of $G$. Suppose $P_1, P_2 \in \operatorname{Syl}_p(G)$ are distinct and $P_1 \cap P_2$ is minimal among all the subgroups that are the intersection of two distinct Sylow $p$-subgroups. Suppose $N$ is a subgroup of $P_1 \cap P_2$ and $N \trianglelefteq P_i$ for $i = 1, 2$, and let $H := N_G(N)$.
...
(d) Suppose $P_1$ is abelian. Prove that
\[
