...
Define $p : E \to S^1 \vee S^1$.

(a) Verify that $p$ is a covering space map.

(b) Let $\alpha : (I, 0) \to (E, (0, 0))$ be the loop which traverses the unit square $I = \{0, 1\} \cup \{0, 1\} \times I$ once counterclockwise.
Prove that $p \alpha$ is the commutator of the two loops of the figure-eight.
