...
(b) Let $A:G\to GL_n(\mathbb{C})$ and $B:G\to GL_n(\mathbb{C})$ be two representations of a finite group $G$. Show that if for all $\sigma\in G$, there exists a matrix $P(\sigma)$ such that
\[
