...
(a) Prove that for any positive $R_1$ and $R_2$ with $R_2 > R_1$,
$$\int_0^{2\pi} \left(u(R_2 e^{i\theta}) - u(R_1 e^{i\theta})\right)d\theta \geq \int_{R_1 \leq |z| \leq R_2} \log\left(\frac{R_2}{|z|}\right) \Delta u \, dx\,dy.$$
