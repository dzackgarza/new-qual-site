...
(b) More generally, an open set $\Omega \subset \mathbb { C }$ is star-shaped if there exists a point $z _ { 0 } \in \Omega$ such that for any $z \in \Omega ,$ the straight line segment between z and z is contained in Ω. Prove that a star-shaped open set is simply connected. Conclude that the slit plane $\mathbb { C } - \{ ( - \infty , 0 ] \}$ (and more generally any sector, convex or not) is simply connected.
