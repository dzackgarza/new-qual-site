...
(a) (10 pts) Let $1 \leq p \leq \infty$. Show that for fixed $M > 0$ the ball $\{f : \|f\|_{L^p(d\mu)} \leq M\}$ is closed in $L^1(d\mu)$.
...
(c) (10 pts) Now let $1 < p \leq \infty$. Show that the assumptions of part (b) above hold iff both $L^p(d\mu)$ and $L^1(d\mu)$ are finite dimensional.
