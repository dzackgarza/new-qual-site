...
::: problem
Let $(X, \mathcal{M}, \mu)$ be a finite measure space, and $0 \leq h_1 \leq h_2 \leq \cdots \leq f$ be nonnegative measurable functions on $X$ with $\lim f_j(x) = f(x)$ for almost every $x \in X$.
