...
$$
where $P_r(t) := \operatorname{Re} \frac{1 + re^{it}}{1 - re^{it}}$ is the Poisson kernel in $\mathbb{D}$. Assume that $f$ is continuous at $a = e^{i\theta_0}$, and show that $\lim_{z \to a} u(z) = f(a)$.
:::
