...
(a) For each compact subspace $C$ of $X$, show that the union of the sets $g(C)$, for $g \in G$, is closed in $X$. [Hint: If $U$ is a neighborhood of $x$ with $\overline{U}$ compact, then $\overline{U} \cup C$ intersects $g(\overline{U} \cup C)$ for only finitely many $g$.]
