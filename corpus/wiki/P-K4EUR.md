...
<1>4. Uniqueness of $g$: if $\int_X (g - g')\bar f = 0$ for all $f \in L^2$, then $g = g'$ a.e.
    Proof: take $f = g - g'$: $\int |g - g'|^2 = 0$, so $g = g'$ a.e.

<1>5. Q.E.D.
    Proof: <1>1, <1>2, <1>3, <1>4 establish the claims. (This is the Riesz representation theorem for $L^2$; the usual proof via $\bar g$ is equivalent.)
:::
