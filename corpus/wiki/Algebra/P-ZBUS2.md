...
Proof: the conjugacy classes of $A_4$ are determined by cycle type, with the $3$-cycles splitting into two classes.
...
Proof: the quotient is cyclic of order $3$, with three linear characters.
<2>3. The remaining representation has degree $3$ (since $1^2 + 1^2 + 1^2 + 3^2 = 12$).
Proof: the sum of squares of degrees is $|A_4| = 12$.
...
Proof: pull back the characters of $A_4/V \cong \ZZ/3$.
...
<1>5. Q.E.D.
Proof: <1>4.3 is the character table of $A_4$.
:::
