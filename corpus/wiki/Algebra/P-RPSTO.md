...
Proof: <1>3 and <1>4.1.
<2>2. If $G$ is abelian and nontrivial, take $G$ itself (or a nontrivial cyclic subgroup).
Proof: <1>4.2.
...
<1>7. Q.E.D.
Proof: <1>5 proves the group statement; <1>6 gives the Galois interpretation.
:::
