...
<1>3. Q.E.D.
    Proof: <1>1 and <1>2 cover $q = \infty$ and $q < \infty$. (This is the standard fact $\ell^p \subseteq \ell^q$ for $p < q$, with the norm inequality; it holds over $\CC$ since only moduli are used.)
:::
