...
::: {.exercise title="Hoffman and Kunze 8.4.3"}
...
(c) For each $\gamma$ in $V$, let $M_\gamma$ be the linear operator on $V$ defined by $M_\gamma(\alpha) = \gamma\alpha$. Show that $(M_\gamma)^* = M_{\overline{\gamma}}$.
