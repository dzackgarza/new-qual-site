...
<1>1. Setup: $f$ continuous on $[0,2]$, differentiable on $(0,2)$, $f(0) = f(2) = 0$, and $f(c) = 1$ for some $c \in (0,2)$. (The card already contains a complete case-analysis proof; this solution restates it in structured form.)
    Proof: given.
