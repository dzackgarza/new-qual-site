...
**Honesty note:** the card states no hypothesis on the sign of $f$; for signed $f$ and odd $n$, $\int f^n$ need not be defined. The standard statement (proved here) is for $f \ge 0$: $\lim_n \int f^n = \infty$ if $\mu\{f > 1\} > 0$, and $= \mu\{f = 1\}$ otherwise.
