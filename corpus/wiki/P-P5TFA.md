...
<1>4. $f(x) \le 1 + \pi/4$ for all $x \ge 1$.
    Proof: integrate <1>3 from $1$ to $x$:
    \[
    f(x) - f(1) = \int_1^x f'(t)\,dt \le \int_1^x \frac{dt}{1+t^2} = \arctan x - \frac{\pi}{4} < \frac{\pi}{2} - \frac{\pi}{4} = \frac{\pi}{4}.
    \]
    Adding $f(1) = 1$ gives the claim.
