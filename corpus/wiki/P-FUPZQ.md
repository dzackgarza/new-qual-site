...
<1>4. Hence
    $$\lim_{x \to a}\frac{a^n f(x) - x^n f(a)}{x - a} = a^n f'(a) - f(a)\,(n a^{n-1}) = a^n f'(a) - n a^{n-1} f(a).$$
    Proof: <1>1 splits the quotient as $a^n\frac{f(x) - f(a)}{x-a} - f(a)\frac{x^n - a^n}{x-a}$, and <1>2, <1>3 give the two limits.
:::
