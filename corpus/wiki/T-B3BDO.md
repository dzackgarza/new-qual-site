...
::: {.remark}
Stein and Shakarchi, *Complex Analysis*, Ch. 2 Theorem 1.1.
This is the base case everything else in Cauchy theory is deduced from: it produces primitives on discs, hence Cauchy's theorem for toy contours, hence the integral formula, hence the power series expansion.
