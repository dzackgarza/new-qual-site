...
Proof: triangle inequality, <2>1, <2>2. <2>4. Q.E.D. Proof: <2>3.
...
Proof: $m^*(C) \le m(C_n) = (2/3)^n$ for all $n$, so $m(C) = 0$; an open interval has positive measure, so no interval is contained in $C$.
