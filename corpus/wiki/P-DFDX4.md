...
<1>1. Cauchy–Hadamard formula: the radius of convergence of $\sum a_n x^n$ is $R = 1/\limsup_{n \to \infty} |a_n|^{1/n}$ (with $1/0 = \infty$, $1/\infty = 0$). Proof: the root test: $\limsup |a_n x^n|^{1/n} = |x| \limsup |a_n|^{1/n}$; the series converges absolutely when this is $< 1$, i.e. $|x| < R$, and diverges when $|x| > R$.
...
<1>5. Q.E.D. Proof: <1>1 is the definition one applies in <1>3 and <1>4.
:::
