...
Proof: <2>1. Substitute $u = \sqrt{x} \implies x = u^2, dx = 2u \, du$.
...
Proof: <2>1. Substitute $u = \sqrt{1-x^2} \implies u^2 = 1-x^2, u \, du = -x \, dx$.
...
Proof: <2>1. Partial fractions: $\frac{1}{x(x^2+1)} = \frac{1}{x} - \frac{x}{x^2+1}$.
