...
<1>4. Q.E.D.: $\ts{u_k}_{k \in \ZZ}$ is an orthonormal system in $\ell^2(\ZZ)$.
    Proof: <1>2 and <1>3 are exactly the two defining properties of orthonormality. (It is in fact an orthonormal basis: $\ell^2(\ZZ)$ is complete, and the $u_k$'s span a dense subspace — the finitely supported sequences.)
:::
