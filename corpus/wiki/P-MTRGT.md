...
id: P-MTRGT
kind: problem
title: $\frac1\pi\iint_{\mathbb D}|\psi_\alpha'|^2=1$ and $\frac1\pi\iint_{\mathbb D}|\psi_\alpha'|=\frac{1-|\alpha|^2}{|\alpha|^2}\log\frac{1}{1-|\alpha|^2}$ for $\psi_\alpha(z)=\frac{\alpha-z}{1-\bar\alpha z}$
classification:
  areas:
  - complex-analysis
  topics:
