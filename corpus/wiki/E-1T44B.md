...
(c) Let $K$ denote the set $\ts{1/n \mid n \in \mathbb{Z}_+}$ and let $-K$ denote the set $\ts{-1/n \mid n \in \mathbb{Z}_+}$. Determine the components, path components, and quasicomponents of the following subspaces of $\mathbb{R}^2$:
...
::: {.remark}
Munkres, *Topology*, §25 Exercise 10.
:::
