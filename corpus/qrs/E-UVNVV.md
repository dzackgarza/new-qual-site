...
<1>6. Q.E.D.
    Proof: <1>3 shows the change of variables $z \leftrightarrow \zeta$ is one-to-one, and <1>5 shows $f$ in these coordinates is $(n+1)$-to-one; composing, $f$ is $(n+1)$-to-one near $z_0$.
