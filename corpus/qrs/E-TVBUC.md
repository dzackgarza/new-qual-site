...
<1>1. Upper bound: $\limsup_{p \to \infty}\|f\|_p \le \|f\|_\infty$.
    ...
    <2>2. Q.E.D.
        Proof: $\mu(E)^{1/p} \to 1$ as $p \to \infty$ since $0 < \mu(E) < \infty$ (the case $\mu(E) = 0$ is trivial, and if $\|f\|_\infty = \infty$ the bound is vacuous but the lower bound below handles it).
...
<1>3. Q.E.D.
    Proof: <1>1 and <1>2 sandwich $\|f\|_p$ between quantities converging to $\|f\|_\infty$.
:::
