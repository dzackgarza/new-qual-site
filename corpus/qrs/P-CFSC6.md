...
<2>3. Q.E.D. Proof: $\int f\,x^{99}h = \lim_k \int f\,x^{99}p_k = 0$ by <1>1, the limit passing under the integral by uniform convergence (or dominated convergence with dominating function $\|f\|_\infty (1 + \|h\|_\infty)$).
