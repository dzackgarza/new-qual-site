...
id: P-653RW
kind: problem
title: Free homotopy of based loops is conjugacy in $\pi_1$
classification:
  areas:
  - topology
  topics:
...
- Loops can be homotopic (i.e. *freely* homotopic) without being homotopic rel a base point, so not equal in $\pi_1(X; x_0)$.
  ...
  ![Image](../../assets/figures/2020-02-04-20%3A00.png)\
:::
...
- Claim: $\gamma_1$ and $T\ast \gamma_2 \ast T\inv$ are homotopic rel $x_0$, making $\gamma_1, \gamma_2$ conjugate in $\pi_1$.
  ...
  ![Image](../../assets/figures/2020-02-04-20%3A23.png)
...
![image_2021-06-04-00-44-45](../../assets/Topology/UGA_Questions_with_solutions/sections/figures/image_2021-06-04-00-44-45.png)
:::
