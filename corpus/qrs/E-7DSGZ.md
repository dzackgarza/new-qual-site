...
<1>3. $f$ maps closed sets to closed sets (in $f(X)$).
    <2>1. Let $C \subseteq X$ be closed; then $C$ is compact.
...
<1>5. Q.E.D.
    Proof: <1>1 and <1>4 show $f: X \to f(X)$ is a homeomorphism, i.e. $f$ is an embedding.
