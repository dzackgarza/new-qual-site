...
<1>5. Remark: the hypothesis that $K$ is compact cannot be weakened to closed. In $\RR$, take $K = \NN$ and $F = \{n + 2^{-n} : n \in \NN\}$: both are closed and disjoint, yet $\dist(K, F) = \inf_n 2^{-n} = 0$.
:::
