...
<2>4. Q.E.D. Proof: <2>2 and <2>3 sandwich the two sides.
...
Proof: apply continuity from below (<1>1) to the increasing sequence $F_n := E_1 \setminus E_n$: $\mu^*(\bigcup_n F_n) = \lim_n \mu^*(F_n)$.
