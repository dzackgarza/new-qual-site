...
<1>1. A uniform limit of bounded functions is bounded.
    ...
    <2>3. Q.E.D.
        Proof: <2>2 bounds $|f|$ uniformly by $\|f_N\|_\infty + 1$.
...
<1>2. A uniform limit of continuous functions is continuous.
    ...
    <2>3. For $|x - x_0| < \delta$: $|f(x) - f(x_0)| \le |f(x) - f_n(x)| + |f_n(x) - f_n(x_0)| + |f_n(x_0) - f(x_0)| < \eps$.
        Proof: triangle inequality; the first and third terms are $< \eps/3$ by uniform convergence (<2>1), the middle by <2>2.
    <2>4. Q.E.D.
        Proof: <2>3 shows $f$ is continuous at the arbitrary point $x_0$.
:::
