...
<2>1. $p$ has exactly 2 roots in $|z| < 1$: the two real roots of <1>2. Proof: the real roots lie in $(0,1) \subset |z| < 1$; the other two roots are non-real (real coefficients), and their product with the real roots equals $3/4$ (constant term), so $|z|^2\,r_1r_2 = \tfrac34$.
...
<1>5. Q.E.D. Proof: <1>1–<1>4 answer the question.
:::
