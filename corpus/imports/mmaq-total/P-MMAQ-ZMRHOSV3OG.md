...
2. Prove the Schwarz-Pick Lemma: for any holomorphic $f: \mathbb{D} \to \mathbb{D}$ and any $a \in \mathbb{D}$, $$\frac{|f'(a)|}{1 - |f(a)|^2} \leq \frac{1}{1 - |a|^2}.$$
...
<1>4. **Compute $g'(0)$ via the Chain Rule.** <2>1. By the chain rule applied to $g(z) = \phi_b(f(\phi_a(z)))$: $$g'(z) = \phi_b'(f(\phi_a(z))) \cdot f'(\phi_a(z)) \cdot \phi_a'(z).$$ *Proof:* Multivariable/complex chain rule.
