...
<2>3. On $|z| = 2$, by the triangle inequality: $$|G_1(z)| = |-6z^2 - z + 1| \leq 6|z|^2 + |z| + 1 = 6(4) + 2 + 1 = 27.$$ *Proof:* Triangle inequality $|a+b+c| \leq |a|+|b|+|c|$.
...
<2>7. Thus, $f(z)$ has exactly 5 zeros in $|z| < 2$.
Moreover, since $|f(z)| \geq |F_1(z)| - |G_1(z)| \geq 64 - 27 = 37 > 0$ on $|z|=2$, $f(z)$ has no zeros on the circle $|z|=2$.
...
<2>3. On $|z| = 1$, by the triangle inequality: $$|G_2(z)| = |2z^5 - z + 1| \leq 2|z|^5 + |z| + 1 = 2(1) + 1 + 1 = 4.$$ *Proof:* Triangle inequality.
...
<2>7. Thus, $f(z)$ has exactly 2 zeros in $|z| < 1$.
Furthermore, on $|z|=1$, $|f(z)| \geq |F_2(z)| - |G_2(z)| \geq 6 - 4 = 2 > 0$, so $f(z)$ has no zeros on the boundary circle $|z|=1$.
*Proof:* Reverse triangle inequality.
<2>8. Q.E.D.
...
*Proof:* Subtraction of counts from <1>1 and <1>2. <2>5. Q.E.D.
:::
