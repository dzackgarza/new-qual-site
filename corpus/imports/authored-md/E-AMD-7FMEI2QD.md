...
Proof: Every proper ideal is contained in a maximal ideal (by Krull's Theorem / Zorn's Lemma).
...
Proof: Any proper ideal $J \subsetneq R$ contains no units, so $J \subseteq R \setminus R^\times = I$.
Thus $I$ contains every proper ideal, making $I$ the unique maximal ideal.
<3>3. Q.E.D. Proof: Follows from <3>1 and <3>2.
...
Proof: Strategy using the characterization lemma <1>1.<2>2. <2>3. $0 \in N$ and $N \neq \emptyset$.
...
Thus $a + b \in N$.
Proof: By <3>4, <3>5, and <3>6. <2>6. By <2>3, <2>4, and <2>5, $N = R \setminus R^\times$ is an ideal of $R$.
...
<2>8. Q.E.D. Proof: Follows from <2>1 through <2>7.
