...
Proof: If $N$ is an ideal, then every proper ideal $I \subsetneq R$ consists solely of non-units, so $I \subseteq N$, making $N$ the unique maximal ideal.
...
Proof: If $x \in \operatorname{Nil}(R)$ were a unit, there would exist $u \in R$ such that $x u = 1$.
...
Proof: Follows from <1>2.<2>3. <2>2. By the characterization in <1>1.<2>1, $R$ is a local ring with unique maximal ideal $\mathfrak{m} = \operatorname{Nil}(R)$.
Proof: The set of non-units is an ideal.
<2>3. Q.E.D. Proof: Follows from <2>1 and <2>2.
