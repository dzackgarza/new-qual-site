...
id: E-AMD-BII4UYJ7
kind: exercise
title: Show that every prime ideal is primary.
classification:
  areas:
  - algebra
  topics:
...
**Goal:** Let $R$ be a commutative ring with identity $1 \neq 0$, and let $\mathfrak{p} \subsetneq R$ be a prime ideal. Prove that $\mathfrak{p}$ is a primary ideal.

<1>1. Definitions:
    <2>1. A proper ideal $\mathfrak{p} \subsetneq R$ is a prime ideal if whenever $a, b \in R$ satisfy $a b \in \mathfrak{p}$, then either $a \in \mathfrak{p}$ or $b \in \mathfrak{p}$.
    ...
    <2>2. A proper ideal $\mathfrak{q} \subsetneq R$ is a primary ideal if whenever $a, b \in R$ satisfy $a b \in \mathfrak{q}$, then either $a \in \mathfrak{q}$ or $b^n \in \mathfrak{q}$ for some positive integer $n \ge 1$ (equivalently, $a \in \mathfrak{q}$ or $b \in \sqrt{\mathfrak{q}}$).
        Proof: Standard definition of a primary ideal.

<1>2. Verification of the primary condition for $\mathfrak{p}$:
    <2>1. Let $\mathfrak{p}$ be a prime ideal. Then $\mathfrak{p} \subsetneq R$ is proper.
    ...
    <2>3. Since $\mathfrak{p}$ is prime, either $a \in \mathfrak{p}$ or $b \in \mathfrak{p}$.
        Proof: By <1>1.<2>1.
    <2>4. If $a \in \mathfrak{p}$, the primary condition is satisfied.
    ...
    <2>7. Since $a, b$ were arbitrary, $\mathfrak{p}$ satisfies the defining condition of a primary ideal.
