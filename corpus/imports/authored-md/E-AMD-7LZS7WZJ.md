...
Proof: Fundamental Theorem of Arithmetic (existence of prime factors for integers $> 1$). <2>3. Since $q \mid b$ and $b \mid a^n$, we have $q \mid a^n$.
...
Proof: Contradicts lowest terms representation in <1>1.<2>2. <2>7. Therefore, $b = 1$.
