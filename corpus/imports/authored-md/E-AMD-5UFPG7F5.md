...
Proof: The bijection between ideals of $R$ containing $I$ and ideals of $R/I$ maps $I$ to $(0)$ and $R$ to $R/I$.
...
Proof: Any ideal $J$ with $I \subseteq J \subseteq R$ corresponds to an ideal $J/I$ of $R/I$.
...
<2>6. Q.E.D. Proof: Follows from <2>1 through <2>5.
