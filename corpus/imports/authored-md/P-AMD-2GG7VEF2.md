...
id: P-AMD-2GG7VEF2
kind: problem
title: Show $\pi_1(S^n) = 1$ for $n\geq 2$.
classification:
  areas:
  - topology
  topics:
...
<1>1. Cover $S^n$ by two open subsets $U$ and $V$.
  ...
  <2>5. Proof: By construction, $\{U, V\}$ is an open cover of $S^n$. Q.E.D.
...
<1>2. $U$ and $V$ are contractible, hence simply connected.
  ...
  <2>5. Proof: Homeomorphisms preserve contractibility, and contractible spaces have trivial fundamental groups. Q.E.D.
...
<1>3. The intersection $U \cap V = S^n \setminus \{N, S\}$ is path-connected for $n \geq 2$.
  ...
  <2>6. Proof: By <2>1–<2>5, $U \cap V$ is nonempty and path-connected. Q.E.D.
...
<1>4. Apply the Seifert-van Kampen theorem to the cover $\{U, V\}$.
  ...
  <2>3. The theorem gives an isomorphism:
  $$\pi_1(S^n, x_0) \cong \pi_1(U, x_0) *_{\pi_1(U \cap V, x_0)} \pi_1(V, x_0).$$
  <2>4. By <1>2, $\pi_1(U, x_0) = 1$ and $\pi_1(V, x_0) = 1$.
  <2>5. The amalgamated free product of two trivial groups is trivial: $1 *_{\pi_1(U \cap V, x_0)} 1 = 1$.
  <2>6. Proof: By direct substitution into the van Kampen isomorphism. Q.E.D.

<1>5. Q.E.D.
  <2>1. Proof: <1>4 establishes $\pi_1(S^n, x_0) = 1$ for all $n \geq 2$.
:::
