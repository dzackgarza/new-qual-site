...
<1>1. Cellular structure of the solid cube quotient $X$.
  ...
  <2>5. Proof: Standard cell-complex construction from polyhedral face identifications. Q.E.D.
...
<1>3. Homology $H_*(X)$.
  ...
  <2>4. Proof: By Hurewicz theorem and Poincaré duality / cellular homology. Q.E.D.

<1>4. Q.E.D.
  <2>1. Proof: Steps <1>1–<1>3 determine the topology, fundamental group, and homology of the quotient cube.
:::
