...
Proof: these are ideals of $\ZZ$.
<2>2. $2 \in I$ and $3 \in J$, so $2, 3 \in I \cup J$.
Proof: each lies in its own ideal.
<2>3. $2 + 3 = 5 \notin I \cup J$.
Proof: $5$ is not divisible by $2$ (so $5 \notin 2\ZZ$) and not divisible by $3$ (so $5 \notin 3\ZZ$).
<2>4. Hence $I \cup J$ is not closed under addition, so it is not an ideal.
Proof: an ideal must be closed under addition.

<1>2. Q.E.D.
Proof: <1>1 gives a union of two ideals that is not an ideal.
:::
