...
1. Since $H \leq S_{p_1}$, by Lagrange's Theorem the order $|H|$ divides $|S_{p_1}| = p_1^{a_1}$ (for some $a_1 \geq 1$). Thus, $|H| = p_1^{k_1}$ for some integer $k_1 \geq 0$.

2. Since $H \leq S_{p_2}$, by Lagrange's Theorem the order $|H|$ divides $|S_{p_2}| = p_2^{a_2}$ (for some $a_2 \geq 1$). Thus, $|H| = p_2^{k_2}$ for some integer $k_2 \geq 0$.
