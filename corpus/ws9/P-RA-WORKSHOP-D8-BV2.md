...
::: {.problem title="?"}
(January 2007, 6a) Let $f$ be a function of bounded variation on $[a,b]$.
Furthermore, assume that for some $c>0$, $|f(x)|\ge c$ on $[a,b]$.
Show that $g(x)=1/f(x)$ is of bounded variation on $[a,b]$.
:::

:::: {.solution}
> **AI-Generated Solution** **Goal:** Show $g = 1/f$ is of bounded variation on $[a,b]$ given $f \in BV[a,b]$ and $|f(x)| \ge c > 0$.
...
<1>3. Q.E.D. Proof: <1>2 shows $g$ has finite total variation, i.e. $g \in BV[a,b]$.
:::
