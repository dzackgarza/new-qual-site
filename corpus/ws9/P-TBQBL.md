...
:::{.problem title="?"}
Indicate whether each of the following if-then statements is true, and give a brief explanation to support your answer. If the statement is false, and there is a reasonable addition to the hypotheses that would make it true, please indicate that as well.
