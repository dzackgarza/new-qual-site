---
schema: qual/card@1
id: SRC-TOP-WORKSHOP-2020
kind: collection
title: UNL topology workshop, May 2020
classification:
  areas:
  - topology
  topics: []
relations:
- kind: related-to
  target: SRC-TOP-UNL-2016Q2
- kind: related-to
  target: SRC-TOP-2013Q2
review: draft
provenance:
- assets/attachments/Topology_Workshop_Worksheet_1A.pdf
- assets/attachments/Topology_Workshop_Worksheet_1B.pdf
- assets/attachments/Topology_Workshop_Worksheet_2A.pdf
- assets/attachments/Topology_Workshop_Worksheet_2B.pdf
- assets/attachments/Topology_Workshop_Worksheet_3A.pdf
- assets/attachments/Topology_Workshop_Worksheet_3B.pdf
- assets/attachments/Topology_Workshop_Worksheet_4A.pdf
- assets/attachments/Topology_Workshop_Worksheet_5.pdf
source:
