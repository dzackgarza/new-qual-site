...
**Goal:** Let $U \supset \overline{D(P,r)}$ be open, $f: U \to \CC$ holomorphic and nowhere zero on $\bd D(P,r)$.
Show that if $g: U \to \CC$ is holomorphic and sufficiently uniformly close to $f$ on $\bd D(P,r)$, then $f$ and $g$ have the same number of zeros in $D(P,r)$ (counting multiplicity).
