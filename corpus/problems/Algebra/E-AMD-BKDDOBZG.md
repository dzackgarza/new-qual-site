...
::: {.proof}
By <1>1.<2>1. <2>3. Since $u \in I$ and $u^{-1} \in R$, by the absorption property of ideals, $1 = u^{-1} u \in I$ (for left ideals) and $1 = u u^{-1} \in I$ (for right ideals).
:::
::: {.proof}
By <1>1.<2>2 with $x = u \in I$ and $r = u^{-1} \in R$.
:::

<1>3. Proof that $I = R$: <2>1. Since $I$ is an ideal of $R$, by definition $I \subseteq R$.
::: {.proof}
An ideal is by definition a subset of $R$.
:::
<2>2. Let $r \in R$ be an arbitrary element.
::: {.proof}
Setting an element to prove $R \subseteq I$.
:::
<2>3. Since $1 \in I$ (<1>2.<2>3), by absorption $r = r \cdot 1 \in I$.
::: {.proof}
By <1>1.<2>2 with $x = 1 \in I$ and ring element $r \in R$.
:::
<2>4. Thus $R \subseteq I$.
::: {.proof}
Since $r \in I$ for every $r \in R$.
:::
