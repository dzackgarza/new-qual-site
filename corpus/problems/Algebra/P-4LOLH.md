...
<1>4. Conclusion:
    In general, $\bigcap_{n=1}^\infty I^n = \{a \in R \mid (1-x)a = 0 \text{ for some } x \in I\}$. In particular, if $R$ is an integral domain or a local ring and $I$ is proper, the intersection is $(0)$. Q.E.D.
:::
