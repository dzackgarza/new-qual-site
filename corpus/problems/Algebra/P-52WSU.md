...
::: {.proof}
Fourier analysis on the torus $\mathbb{T}$.
:::
...
\]
::: {.proof}
definition of Hardy space $H^2(\mathbb{T})$.
:::
...
\]
::: {.proof}
definition of Toeplitz operator.
:::
...
::: {.proof}
boundedness of composition of bounded operators.
:::
...
::: {.proof}
Fourier coefficients of $L^\infty$ functions.
:::
...
\]
::: {.proof}
applying projection $P$ to Fourier series.
:::
...
\]
::: {.proof}
matrix entry calculation $\langle T_\varphi e_j, e_i \rangle = a_{i-j}$.
:::
...
::: {.proof}
Brown–Halmos algebraic characterization of Toeplitz operators.
:::
