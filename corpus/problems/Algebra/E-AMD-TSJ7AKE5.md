...
\]
Proof: conjugation of a subgroup is a subgroup.
...
Proof: associativity of group multiplication.
...
Proof: definition of stabilizer and normalizer.
...
Proof: $g_1 N_G(H) = g_2 N_G(H) \iff g_2^{-1}g_1 \in N_G(H) \iff g_2^{-1}g_1 H g_1^{-1}g_2 = H \iff g_1 H g_1^{-1} = g_2 H g_2^{-1}$.
<2>2. Therefore the number of conjugate subgroups is:
\[
|\mathcal{C}(H)| = |\operatorname{Orb}_G(H)| = |G / N_G(H)| = [G : N_G(H)].
\]
Proof: cardinality of bijective sets and definition of index.
