...
::: {.proof}
the number of irreducible complex representations of a finite group equals the number of conjugacy classes (a standard theorem: the irreducible characters form an orthonormal basis of the space of class functions, whose dimension is the number of conjugacy classes).
:::
