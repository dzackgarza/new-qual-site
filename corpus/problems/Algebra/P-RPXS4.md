...
Proof: standard formula (Möbius inversion on the factorization $x^{q^n} - x = \prod_{d \mid n} \prod_{\text{irred. deg } d} f$).

<1>2. For $q = 2$, $n = 4$: the divisors of $4$ are $1, 2, 4$, with $\mu(1) = 1$, $\mu(2) = -1$, $\mu(4) = 0$.
Proof: values of the Möbius function.

<1>3. Hence $N_2(4) = \frac{1}{4}(2^4 - 2^2 + 0) = \frac{1}{4}(16 - 4) = 3$.
Proof: <1>1 and <1>2.

<1>4. Q.E.D.
Proof: there are $3$ irreducible polynomials of degree $4$ over $\FF_2$ (<1>3).
:::
