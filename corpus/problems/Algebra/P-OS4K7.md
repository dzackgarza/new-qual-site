...
::: {.proof}
groups of order 2 are generated by an involution.
:::
...
::: {.proof}
recognition theorem for semidirect products.
:::
...
\]
::: {.proof}
conjugation action of $Q$ on the normal subgroup $P$.
:::
...
::: {.proof}
homomorphisms preserve element orders.
:::
...
::: {.proof}
solutions to $a^2 \equiv 1 \pmod 7$.
:::
...
- **Case 2 (Non-trivial homomorphism):** $\theta(x)(y) = y^{-1}$, so $x y x^{-1} = y^{-1}$.
  ...
  \]
::: {.proof}
classification of semidirect products $\mathbb{Z}_7 \rtimes \mathbb{Z}_2$.
:::
