...
\]
::: {.proof}
adjugate identity $\operatorname{adj}(A) A = (\det A) I_n$.
:::
...
::: {.proof}
definition of an integral domain (no zero divisors).
:::
...
::: {.proof}
construction of field of fractions.
:::
...
::: {.proof}
invertible matrix theorem over fields.
:::
...
::: {.proof}
clearing denominators in the field of fractions.
:::
...
However, $\det A = 2 \not\equiv 0 \pmod 4$.
::: {.proof}
explicit counterexample with zero divisors.
:::
...
::: {.proof}
McCoy's Rank Theorem for matrices over commutative rings.
:::
