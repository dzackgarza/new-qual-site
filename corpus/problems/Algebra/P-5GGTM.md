...
<1>1. Definition of a simple ring: A non-zero ring $R$ is simple if its only two-sided ideals are the zero ideal $(0)$ and the improper ideal $R$.

<1>2. Classification of ideals in a field: *Proof:* <2>1. Let $I \subseteq F$ be an ideal of the field $F$.
...
<1>3. Conclusion: The only ideals in $F$ are $(0)$ and $F$, so $F$ is a simple ring.
Q.E.D.
:::
