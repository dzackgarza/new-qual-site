...
Proof: matrix entry comparisons.
...
Proof: scalar matrices form the full center.
...
Proof: determinant of transvection is 1.
...
Proof: identical transvection commutation argument inside $\operatorname{SL}_n(\mathbb{F}_p)$.
...
\]
Proof: determinant of scalar matrix is $\zeta^n$.
...
\]
Proof: roots of $x^n - 1$ in the cyclic group $\mathbb{F}_p^\times \cong \mathbb{Z}_{p-1}$.
