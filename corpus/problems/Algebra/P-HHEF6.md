...
Proof: statement of the Jordan–Hölder theorem.
...
Proof: take two composition series.
...
Proof: induction hypothesis applied to $G_1 = H_1$.

<1>5. If $G_1 \neq H_1$, then $G_1 H_1 = G$ (since $G_1$ and $H_1$ are distinct maximal normal subgroups, their product is $G$).
Proof: $G_1 H_1$ is a normal subgroup of $G$ containing $G_1$ properly, so by maximality of $G_1$ it is $G$.
...
Proof: $G_1 \cap H_1$ has a composition series.
...
Proof: refine the series through $G_1 \cap H_1$.
