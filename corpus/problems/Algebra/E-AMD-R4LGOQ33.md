...
::: {.proof}
<2>1. The class equation $$\abs G = \abs{Z(G)} + \sum_i [G : C_G(x_i)]$$ over representatives of the conjugacy classes of size greater than $1$ has every index divisible by $p$, so $p$ divides $\abs{Z(G)}$ and $Z(G) \neq 1$.
