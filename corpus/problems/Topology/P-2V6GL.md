...
::: {.proof}
at any point $(0, y)$ on the vertical segment, no small neighborhood is connected (every neighborhood contains infinitely many "oscillations" of the sine curve, which are disconnected from each other).
:::
