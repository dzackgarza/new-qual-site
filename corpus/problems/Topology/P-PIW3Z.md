...
Proof: standard computation of the cohomology of $S^2$.
...
Proof: Künneth theorem; since $H^*(S^2;\ZZ)$ is free, $\operatorname{Tor}$ vanishes.
...
<1>5. Q.E.D.
Proof: <1>4, matching the known answer $[\ZZ, 0, \ZZ^2, 0, \ZZ, 0, \ldots]$.
:::
