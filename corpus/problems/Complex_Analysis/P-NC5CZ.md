...
::: {.proof}
By Morera's theorem, a continuous function on an open set with vanishing integrals over all closed triangles is holomorphic; <1>1 gives continuity and <1>2 gives the vanishing integrals.
:::
