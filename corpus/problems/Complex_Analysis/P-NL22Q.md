...
::: {.proof}
If $Z$ contained a nonempty open set $U$, then $f \equiv 0$ on $U$, and by the identity theorem $f \equiv 0$ on $D$, contradicting <1>1.
:::
...
<1>5. $g \equiv 0$ on $D$.
::: {.proof}
<1>3 gives a nonempty open set (e.g. a disk contained in $D \setminus Z$) on which $g$ vanishes; by the identity theorem, $g$ vanishes on all of $D$.
:::

<1>6. Q.E.D.
::: {.proof}
<1>1--<1>5 show that if $f \not\equiv 0$ then $g \equiv 0$; the alternative case is symmetric.
:::
:::
