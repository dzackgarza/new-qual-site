...
::: {.proof}
Absolute convergence (comparison test, <2>1--<2>2) implies convergence.
:::
...
::: {.proof}
Dirichlet's test: a series $\sum a_n b_n$ converges if the partial sums of $\sum a_n$ are bounded and $b_n \downarrow 0$; take $a_n = z^n$, $b_n = 1/n$, using <2>1 and <2>2.
:::

<1>5. Q.E.D.
::: {.proof}
<1>1 proves (a); <1>2 proves (b); <1>3 and <1>4 prove (c).
:::
:::
