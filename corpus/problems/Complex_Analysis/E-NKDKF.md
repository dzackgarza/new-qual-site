...
::: {.proof}
<1>1 with $b = a$: a closed curve has $z(1) = z(0)$.
:::
...
<1>4. Q.E.D.
::: {.proof}
<1>1–<1>3 prove the claim for (piecewise) smooth closed curves, which is the standard meaning of $\int_\gamma f$ in this context.
:::
:::
