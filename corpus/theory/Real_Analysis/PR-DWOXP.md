...
Without such a hypothesis nothing survives: by the [[FT-ITKJU|Weierstrass approximation theorem]], every continuous function on $[a,b]$, including a nowhere differentiable one, is a uniform limit of polynomials.
:::
