...
It represents $A$-derivations: $\Hom_B(\Omega_{B/A}, M) = \operatorname{Der}_A(B, M)$.
For a morphism of schemes $f: X \to Y$, the sheaf $\Omega_{X/Y}$ is obtained by gluing the $\widetilde{\Omega_{B/A}}$ over affines, equivalently as $\Delta^*(\mathcal{I}/\mathcal{I}^2)$ for $\mathcal{I}$ the ideal of the diagonal.
:::
