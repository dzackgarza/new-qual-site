...
Let $S = \bigoplus_{d \geq 0} S_d$ be a graded ring and $S_+ \da \bigoplus_{d \geq 1} S_d$ the **irrelevant ideal**.
Then $\Proj S$ is the set of homogeneous primes $\mfp$ with $\mfp \not\supseteq S_+$, topologised by the closed sets $V(\mfa) = \ts{\mfp \st \mfp \supseteq \mfa}$ for $\mfa$ homogeneous.
