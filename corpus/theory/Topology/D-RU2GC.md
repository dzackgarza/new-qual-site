...
::: {.remark}
A simplicial map extends to a continuous map $\abs{K}\to\abs{L}$ of underlying spaces that is affine on each simplex: $\sum_it_iv_i\mapsto\sum_it_if(v_i)$ for $t_i\geq0$ with $\sum_it_i=1$ [@Mun84].
:::
