...
$$
of $R$-modules and $R$-linear maps; equivalently, $i$ is injective, $j$ is surjective, and $\im i=\ker j$ [@Hat02, p. 114].
...
(c) there is an isomorphism $B\cong A\oplus C$ under which $i$ becomes $a\mapsto(a,0)$ and $j$ becomes $(a,c)\mapsto c$ [@Hat02, p. 147].
:::
