...
::: {.remark}
The action is free, so $S^{2n-1}\to L_m(\ell_1,\ldots,\ell_n)$ is a covering space [@Hat02], and $L_m(\ell_1,\ldots,\ell_n)$ is a closed $(2n-1)$-manifold.
For $n\geq 2$ the sphere $S^{2n-1}$ is simply connected, so it is the universal cover and $\pi_1(L_m(\ell_1,\ldots,\ell_n)) \cong \ZZ/m$ [@Hat02].
