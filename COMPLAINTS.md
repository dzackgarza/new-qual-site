...
`corpus/problems/Algebra/P-O5YG6.md` says every normal subgroup of a finite $p$-group meets the center nontrivially; the trivial normal subgroup is an immediate counterexample. The intended standard theorem requires a nontrivial normal subgroup.
