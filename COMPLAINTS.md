...
### `P-BZEYY` says $S_n$ is generated by disjoint cycles

- **Object and need:** `P-BZEYY` is titled and phrased as “$S_n$ is generated by disjoint cycles.”
- **Observed evidence:** Pairwise disjoint cycles commute, so any subgroup generated by a pairwise disjoint family is abelian; for $n\ge3$, $S_n$ is nonabelian. The standard intended theorem is that every permutation decomposes as a product of pairwise disjoint cycles.
- **Impact and owner:** The title and body of `corpus/problems/Algebra/P-BZEYY.md` state a false theorem.
- **Uncertainty:** None; the classification topic and standard result determine the intended repair.
- **Repair:** Under TODO §7 / issue #2, replace “generated by” with the disjoint-cycle decomposition theorem and prove existence and uniqueness up to order/cyclic rotation.
