...
### Algebra P-Q5D6X omits the matrix size

`corpus/problems/Algebra/P-Q5D6X.md` asks for “the number of invertible matrices over $\ZZ/p\ZZ$” without specifying a matrix size. The intended finite-general-linear-group formula depends on $n$ and should be stated for $GL_n(\FF_p)$.
