...
Result: FAIL for the complete pinned source boundary.

Source revision: `e6686855d9db6dbe815432c3cb8b0597b7cc4fb6`. Inventory: 1,471 tracked paths.
The ledger has 1,280 migrated, 23 generated, 168 dropped, and 0 queued rows.
It has 255 byte-identical native source copies.

The independent reviewer directly reviewed all 197 transformed Markdown projections.
...
The target has image payloads, but source-to-target identity cannot be proved:
...
The target payloads are retained.
The missing pinned source blobs block the plan's complete source-identity gate.
